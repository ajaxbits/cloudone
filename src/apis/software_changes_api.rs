...
pub fn describe_software_change(
    configuration: &configuration::Configuration,
    software_change_id: i64,
    api_version: &str,
) -> Result<crate::models::SoftwareChange, Error<DescribeSoftwareChangeError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/softwarechanges/{softwareChangeID}",
        configuration.base_path,
        softwareChangeID = software_change_id
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeSoftwareChangeError> =
...
pub fn list_software_changes(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::SoftwareChanges, Error<ListSoftwareChangesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListSoftwareChangesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn review_software_changes(
    configuration: &configuration::Configuration,
    api_version: &str,
    software_change_review: crate::models::SoftwareChangeReview,
) -> Result<crate::models::SoftwareChangeReview, Error<ReviewSoftwareChangesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReviewSoftwareChangesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_software_changes(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::SoftwareChanges, Error<SearchSoftwareChangesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSoftwareChangesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
