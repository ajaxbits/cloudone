...
pub fn create_aws_connector(
    configuration: &configuration::Configuration,
    api_version: &str,
    aws_connector: crate::models::AwsConnector,
) -> Result<crate::models::AwsConnector, Error<CreateAwsConnectorError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateAwsConnectorError> =
...
pub fn delete_aws_connector(
    configuration: &configuration::Configuration,
    aws_connector_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteAwsConnectorError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/awsconnectors/{awsConnectorID}",
        configuration.base_path,
        awsConnectorID = aws_connector_id
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteAwsConnectorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_aws_connector(
    configuration: &configuration::Configuration,
    aws_connector_id: i32,
    api_version: &str,
) -> Result<crate::models::AwsConnector, Error<DescribeAwsConnectorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeAwsConnectorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_aws_connectors(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::AwsConnectors, Error<ListAwsConnectorsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAwsConnectorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_aws_connector(
    configuration: &configuration::Configuration,
    aws_connector_id: i32,
    api_version: &str,
    aws_connector: crate::models::AwsConnector,
    sync: Option<bool>,
) -> Result<crate::models::AwsConnector, Error<ModifyAwsConnectorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyAwsConnectorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_aws_connectors(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::AwsConnectors, Error<SearchAwsConnectorsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchAwsConnectorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
