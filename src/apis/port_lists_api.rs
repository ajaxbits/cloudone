...
pub fn create_port_list(
    configuration: &configuration::Configuration,
    api_version: &str,
    port_list: crate::models::PortList,
) -> Result<crate::models::PortList, Error<CreatePortListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePortListError> =
...
pub fn delete_port_list(
    configuration: &configuration::Configuration,
    port_list_id: i32,
    api_version: &str,
) -> Result<(), Error<DeletePortListError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePortListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_port_list(
    configuration: &configuration::Configuration,
    port_list_id: i32,
    api_version: &str,
) -> Result<crate::models::PortList, Error<DescribePortListError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribePortListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_port_lists(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::PortLists, Error<ListPortListsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPortListsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_port_list(
    ...
    port_list_id: i32,
    api_version: &str,
    port_list: Option<crate::models::PortList>,
) -> Result<crate::models::PortList, Error<ModifyPortListError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyPortListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_port_lists(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::PortLists, Error<SearchPortListsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchPortListsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
