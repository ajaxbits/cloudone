...
pub fn create_port_list(configuration: &configuration::Configuration, api_version: &str, port_list: crate::models::PortList) -> Result<crate::models::PortList, Error<CreatePortListError>> {
...
pub fn delete_port_list(configuration: &configuration::Configuration, port_list_id: i32, api_version: &str) -> Result<(), Error<DeletePortListError>> {
...
pub fn describe_port_list(configuration: &configuration::Configuration, port_list_id: i32, api_version: &str) -> Result<crate::models::PortList, Error<DescribePortListError>> {
...
pub fn list_port_lists(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::PortLists, Error<ListPortListsError>> {
...
pub fn modify_port_list(configuration: &configuration::Configuration, port_list_id: i32, api_version: &str, port_list: Option<crate::models::PortList>) -> Result<crate::models::PortList, Error<ModifyPortListError>> {
...
pub fn search_port_lists(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::PortLists, Error<SearchPortListsError>> {
