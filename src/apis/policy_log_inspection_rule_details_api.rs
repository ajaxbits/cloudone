...
pub async fn describe_log_inspection_rule_on_policy(configuration: &configuration::Configuration, policy_id: i32, log_inspection_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::LogInspectionRule, Error<DescribeLogInspectionRuleOnPolicyError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/policies/{policyID}/loginspection/rules/{logInspectionRuleID}", configuration.base_path, policyID=policy_id, logInspectionRuleID=log_inspection_rule_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeLogInspectionRuleOnPolicyError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn list_log_inspection_rules_on_policy(configuration: &configuration::Configuration, policy_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::LogInspectionRules, Error<ListLogInspectionRulesOnPolicyError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/policies/{policyID}/loginspection/rules", configuration.base_path, policyID=policy_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListLogInspectionRulesOnPolicyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn modify_log_inspection_rule_on_policy(configuration: &configuration::Configuration, policy_id: i32, log_inspection_rule_id: i32, api_version: &str, log_inspection_rule: crate::models::LogInspectionRule, overrides: Option<bool>) -> Result<crate::models::LogInspectionRule, Error<ModifyLogInspectionRuleOnPolicyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyLogInspectionRuleOnPolicyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reset_log_inspection_rule_on_policy(configuration: &configuration::Configuration, policy_id: i32, log_inspection_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::LogInspectionRule, Error<ResetLogInspectionRuleOnPolicyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetLogInspectionRuleOnPolicyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
