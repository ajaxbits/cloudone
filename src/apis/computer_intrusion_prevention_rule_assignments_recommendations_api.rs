...
pub fn add_intrusion_prevention_rule_ids_to_computer(
    ...
    crate::models::IntrusionPreventionAssignments,
    Error<AddIntrusionPreventionRuleIdsToComputerError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddIntrusionPreventionRuleIdsToComputerError> =
...
pub fn list_intrusion_prevention_rule_ids_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    ...
    crate::models::IntrusionPreventionAssignments,
    Error<ListIntrusionPreventionRuleIdsOnComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntrusionPreventionRuleIdsOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn remove_intrusion_prevention_rule_id_from_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    ...
    crate::models::IntrusionPreventionAssignments,
    Error<RemoveIntrusionPreventionRuleIdFromComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveIntrusionPreventionRuleIdFromComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn set_intrusion_prevention_rule_ids_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    ...
    crate::models::IntrusionPreventionAssignments,
    Error<SetIntrusionPreventionRuleIdsOnComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetIntrusionPreventionRuleIdsOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
