...
pub fn create_scheduled_task(
    ...
    api_version: &str,
    scheduled_task: crate::models::ScheduledTask,
) -> Result<crate::models::ScheduledTask, Error<CreateScheduledTaskError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateScheduledTaskError> =
...
pub fn delete_scheduled_task(
    ...
    api_version: &str,
) -> Result<(), Error<DeleteScheduledTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteScheduledTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_scheduled_task(
    configuration: &configuration::Configuration,
    scheduled_task_id: i32,
    api_version: &str,
) -> Result<crate::models::ScheduledTask, Error<DescribeScheduledTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeScheduledTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_scheduled_tasks(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::ScheduledTasks, Error<ListScheduledTasksError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListScheduledTasksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_scheduled_task(
    configuration: &configuration::Configuration,
    scheduled_task_id: i32,
    api_version: &str,
    scheduled_task: crate::models::ScheduledTask,
) -> Result<crate::models::ScheduledTask, Error<ModifyScheduledTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyScheduledTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_scheduled_tasks(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::ScheduledTasks, Error<SearchScheduledTasksError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchScheduledTasksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
