...
pub fn create_computer_group(
    configuration: &configuration::Configuration,
    api_version: &str,
    computer_group: crate::models::ComputerGroup,
) -> Result<crate::models::ComputerGroup, Error<CreateComputerGroupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateComputerGroupError> =
...
pub fn delete_computer_group(
    configuration: &configuration::Configuration,
    computer_group_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteComputerGroupError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteComputerGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_computer_group(
    configuration: &configuration::Configuration,
    computer_group_id: i32,
    api_version: &str,
) -> Result<crate::models::ComputerGroup, Error<DescribeComputerGroupError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeComputerGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_computer_groups(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::ComputerGroups, Error<ListComputerGroupsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListComputerGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_computer_group(
    configuration: &configuration::Configuration,
    computer_group_id: i32,
    api_version: &str,
    computer_group: Option<crate::models::ComputerGroup>,
) -> Result<crate::models::ComputerGroup, Error<ModifyComputerGroupError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyComputerGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_computer_groups(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::ComputerGroups, Error<SearchComputerGroupsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchComputerGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
