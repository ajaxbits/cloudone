...
pub fn add_intrusion_prevention_rule_ids_to_policy(
    ...
    Error<AddIntrusionPreventionRuleIdsToPolicyError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddIntrusionPreventionRuleIdsToPolicyError> =
...
pub fn list_intrusion_prevention_rule_ids_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    ...
    crate::models::IntrusionPreventionAssignments,
    Error<ListIntrusionPreventionRuleIdsOnPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntrusionPreventionRuleIdsOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn remove_intrusion_prevention_rule_id_from_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    ...
    crate::models::IntrusionPreventionAssignments,
    Error<RemoveIntrusionPreventionRuleIdFromPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveIntrusionPreventionRuleIdFromPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn set_intrusion_prevention_rule_ids_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    ...
    crate::models::IntrusionPreventionAssignments,
    Error<SetIntrusionPreventionRuleIdsOnPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetIntrusionPreventionRuleIdsOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
