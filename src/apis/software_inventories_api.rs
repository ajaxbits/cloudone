...
pub fn create_software_inventory(
    configuration: &configuration::Configuration,
    api_version: &str,
    software_inventory: crate::models::SoftwareInventory,
) -> Result<crate::models::SoftwareInventory, Error<CreateSoftwareInventoryError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSoftwareInventoryError> =
...
pub fn delete_software_inventory(
    configuration: &configuration::Configuration,
    software_inventory_id: i64,
    api_version: &str,
) -> Result<(), Error<DeleteSoftwareInventoryError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/softwareinventories/{softwareInventoryID}",
        configuration.base_path,
        softwareInventoryID = software_inventory_id
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSoftwareInventoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_software_inventory(
    configuration: &configuration::Configuration,
    software_inventory_id: i64,
    api_version: &str,
) -> Result<crate::models::SoftwareInventory, Error<DescribeSoftwareInventoryError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeSoftwareInventoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_software_inventory_item(
    configuration: &configuration::Configuration,
    software_inventory_id: i64,
    inventory_item_id: i64,
    api_version: &str,
) -> Result<crate::models::InventoryItem, Error<DescribeSoftwareInventoryItemError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeSoftwareInventoryItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_software_inventories(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::SoftwareInventories, Error<ListSoftwareInventoriesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListSoftwareInventoriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_software_inventory_items(
    configuration: &configuration::Configuration,
    software_inventory_id: i64,
    api_version: &str,
) -> Result<crate::models::InventoryItems, Error<ListSoftwareInventoryItemsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListSoftwareInventoryItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_software_inventories(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::SoftwareInventories, Error<SearchSoftwareInventoriesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSoftwareInventoriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_software_inventory_items(
    configuration: &configuration::Configuration,
    software_inventory_id: i64,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::InventoryItems, Error<SearchSoftwareInventoryItemsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSoftwareInventoryItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
