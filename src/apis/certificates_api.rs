...
pub fn add_certificate(configuration: &configuration::Configuration, api_version: &str, certificate: crate::models::Certificate) -> Result<crate::models::Certificate, Error<AddCertificateError>> {
...
pub fn delete_certificate(configuration: &configuration::Configuration, certificate_id: i32, api_version: &str) -> Result<(), Error<DeleteCertificateError>> {
...
pub fn describe_certificate(configuration: &configuration::Configuration, certificate_id: i32, api_version: &str) -> Result<crate::models::Certificate, Error<DescribeCertificateError>> {
...
pub fn list_certificates(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::Certificates, Error<ListCertificatesError>> {
...
pub fn target_certificate(configuration: &configuration::Configuration, URL: &str, api_version: &str) -> Result<crate::models::Certificate, Error<TargetCertificateError>> {
