...
pub async fn add_certificate(configuration: &configuration::Configuration, api_version: &str, certificate: crate::models::Certificate) -> Result<crate::models::Certificate, Error<AddCertificateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddCertificateError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_certificate(configuration: &configuration::Configuration, certificate_id: i32, api_version: &str) -> Result<(), Error<DeleteCertificateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/certificates/{certificateID}", configuration.base_path, certificateID=certificate_id);
...
pub async fn describe_certificate(configuration: &configuration::Configuration, certificate_id: i32, api_version: &str) -> Result<crate::models::Certificate, Error<DescribeCertificateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeCertificateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_certificates(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::Certificates, Error<ListCertificatesError>> {
...
pub async fn target_certificate(configuration: &configuration::Configuration, URL: &str, api_version: &str) -> Result<crate::models::Certificate, Error<TargetCertificateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TargetCertificateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
