...
/// struct for typed errors of method `create_moved_computers`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateMovedComputersError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `describe_moved_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DescribeMovedComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_moved_computers`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListMovedComputersError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `search_moved_computers`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchMovedComputersError {
    Status403(),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_moved_computers(configuration: &configuration::Configuration, api_version: &str, moved_computer: crate::models::MovedComputer) -> Result<crate::models::MovedComputer, Error<CreateMovedComputersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/movedcomputers", configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&moved_computer);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateMovedComputersError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn describe_moved_computer(configuration: &configuration::Configuration, moved_computer_id: i32, api_version: &str) -> Result<crate::models::MovedComputer, Error<DescribeMovedComputerError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/movedcomputers/{movedComputerID}", configuration.base_path, movedComputerID=moved_computer_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeMovedComputerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_moved_computers(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::MovedComputers, Error<ListMovedComputersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListMovedComputersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_moved_computers(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::MovedComputers, Error<SearchMovedComputersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/movedcomputers/search", configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchMovedComputersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
