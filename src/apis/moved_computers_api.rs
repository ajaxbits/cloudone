...
pub fn create_moved_computers(
    configuration: &configuration::Configuration,
    api_version: &str,
    moved_computer: crate::models::MovedComputer,
) -> Result<crate::models::MovedComputer, Error<CreateMovedComputersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateMovedComputersError> =
...
pub fn describe_moved_computer(
    configuration: &configuration::Configuration,
    moved_computer_id: i32,
    api_version: &str,
) -> Result<crate::models::MovedComputer, Error<DescribeMovedComputerError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/movedcomputers/{movedComputerID}",
        configuration.base_path,
        movedComputerID = moved_computer_id
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeMovedComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_moved_computers(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::MovedComputers, Error<ListMovedComputersError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListMovedComputersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_moved_computers(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::MovedComputers, Error<SearchMovedComputersError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchMovedComputersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
