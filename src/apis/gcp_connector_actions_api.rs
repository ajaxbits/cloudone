...
pub fn create_gcp_connector_action(configuration: &configuration::Configuration, gcp_connector_id: i32, api_version: &str, action: crate::models::Action) -> Result<crate::models::Action, Error<CreateGcpConnectorActionError>> {
...
pub fn describe_gcp_connector_action(configuration: &configuration::Configuration, gcp_connector_id: i32, action_id: i64, api_version: &str) -> Result<crate::models::Action, Error<DescribeGcpConnectorActionError>> {
