...
pub fn create_gcp_connector_action(
    configuration: &configuration::Configuration,
    gcp_connector_id: i32,
    api_version: &str,
    action: crate::models::Action,
) -> Result<crate::models::Action, Error<CreateGcpConnectorActionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateGcpConnectorActionError> =
...
pub fn describe_gcp_connector_action(
    configuration: &configuration::Configuration,
    gcp_connector_id: i32,
    action_id: i64,
    api_version: &str,
) -> Result<crate::models::Action, Error<DescribeGcpConnectorActionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeGcpConnectorActionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
