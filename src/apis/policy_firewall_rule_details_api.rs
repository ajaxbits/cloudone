...
pub fn describe_firewall_rule_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    firewall_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRule, Error<DescribeFirewallRuleOnPolicyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeFirewallRuleOnPolicyError> =
...
pub fn list_firewall_rules_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRules, Error<ListFirewallRulesOnPolicyError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFirewallRulesOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_firewall_rule_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    firewall_rule_id: i32,
    api_version: &str,
    ...
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRule, Error<ModifyFirewallRuleOnPolicyError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyFirewallRuleOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_firewall_rule_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    firewall_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRule, Error<ResetFirewallRuleOnPolicyError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetFirewallRuleOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
