...
pub fn describe_integrity_monitoring_rule_on_policy(
    ...
    crate::models::IntegrityMonitoringRule,
    Error<DescribeIntegrityMonitoringRuleOnPolicyError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeIntegrityMonitoringRuleOnPolicyError> =
...
pub fn list_integrity_monitoring_rules_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::IntegrityMonitoringRules, Error<ListIntegrityMonitoringRulesOnPolicyError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntegrityMonitoringRulesOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_integrity_monitoring_rule_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    integrity_monitoring_rule_id: i32,
    api_version: &str,
    ...
    overrides: Option<bool>,
) -> Result<crate::models::IntegrityMonitoringRule, Error<ModifyIntegrityMonitoringRuleOnPolicyError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyIntegrityMonitoringRuleOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_integrity_monitoring_rule_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    integrity_monitoring_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::IntegrityMonitoringRule, Error<ResetIntegrityMonitoringRuleOnPolicyError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetIntegrityMonitoringRuleOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
