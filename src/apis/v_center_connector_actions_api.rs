...
pub fn create_v_center_connector_action(
    configuration: &configuration::Configuration,
    virtual_id: i32,
    api_version: &str,
    v_center_connector_action: crate::models::VCenterConnectorAction,
) -> Result<crate::models::VCenterConnectorAction, Error<CreateVCenterConnectorActionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateVCenterConnectorActionError> =
...
pub fn describe_v_center_connector_action(
    configuration: &configuration::Configuration,
    virtual_id: i32,
    action_id: i64,
    api_version: &str,
) -> Result<crate::models::VCenterConnectorAction, Error<DescribeVCenterConnectorActionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeVCenterConnectorActionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
