...
pub fn describe_intrusion_prevention_application_type_on_policy(
    ...
    Error<DescribeIntrusionPreventionApplicationTypeOnPolicyError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeIntrusionPreventionApplicationTypeOnPolicyError> =
...
pub fn list_intrusion_prevention_application_types_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    ...
    Error<ListIntrusionPreventionApplicationTypesOnPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntrusionPreventionApplicationTypesOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_intrusion_prevention_application_type_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    application_type_id: i32,
    api_version: &str,
    ...
    crate::models::ApplicationType,
    Error<ModifyIntrusionPreventionApplicationTypeOnPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyIntrusionPreventionApplicationTypeOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_intrusion_prevention_application_type_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    application_type_id: i32,
    api_version: &str,
    ...
    crate::models::ApplicationType,
    Error<ResetIntrusionPreventionApplicationTypeOnPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetIntrusionPreventionApplicationTypeOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
