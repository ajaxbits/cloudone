...
pub fn delete_context(
    ...
    context_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteContextError>> {
    let local_var_client = &configuration.client;
...
pub fn describe_context(
    ...
    context_id: i32,
    api_version: &str,
) -> Result<crate::models::Context, Error<DescribeContextError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeContextError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_contexts(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::Contexts, Error<ListContextsError>> {
    let local_var_client = &configuration.client;
...
pub fn modify_context(
    ...
    api_version: &str,
    context: crate::models::Context,
) -> Result<crate::models::Context, Error<ModifyContextError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyContextError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_contexts(
...
) -> Result<crate::models::Contexts, Error<SearchContextsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchContextsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
