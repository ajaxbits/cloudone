...
pub fn create_context(configuration: &configuration::Configuration, api_version: &str, context: crate::models::Context) -> Result<crate::models::Context, Error<CreateContextError>> {
...
pub fn delete_context(configuration: &configuration::Configuration, context_id: i32, api_version: &str) -> Result<(), Error<DeleteContextError>> {
...
pub fn describe_context(configuration: &configuration::Configuration, context_id: i32, api_version: &str) -> Result<crate::models::Context, Error<DescribeContextError>> {
...
pub fn list_contexts(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::Contexts, Error<ListContextsError>> {
...
pub fn modify_context(configuration: &configuration::Configuration, context_id: i32, api_version: &str, context: crate::models::Context) -> Result<crate::models::Context, Error<ModifyContextError>> {
...
pub fn search_contexts(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::Contexts, Error<SearchContextsError>> {
