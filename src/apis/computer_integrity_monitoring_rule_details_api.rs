...
/// struct for typed errors of method `describe_integrity_monitoring_rule_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DescribeIntegrityMonitoringRuleOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_integrity_monitoring_rules_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListIntegrityMonitoringRulesOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `modify_integrity_monitoring_rule_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModifyIntegrityMonitoringRuleOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `reset_integrity_monitoring_rule_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ResetIntegrityMonitoringRuleOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}
...
pub async fn describe_integrity_monitoring_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, integrity_monitoring_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntegrityMonitoringRule, Error<DescribeIntegrityMonitoringRuleOnComputerError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/computers/{computerID}/integritymonitoring/rules/{integrityMonitoringRuleID}", configuration.base_path, computerID=computer_id, integrityMonitoringRuleID=integrity_monitoring_rule_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeIntegrityMonitoringRuleOnComputerError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn list_integrity_monitoring_rules_on_computer(configuration: &configuration::Configuration, computer_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntegrityMonitoringRules, Error<ListIntegrityMonitoringRulesOnComputerError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/computers/{computerID}/integritymonitoring/rules", configuration.base_path, computerID=computer_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntegrityMonitoringRulesOnComputerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn modify_integrity_monitoring_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, integrity_monitoring_rule_id: i32, api_version: &str, integrity_monitoring_rule: crate::models::IntegrityMonitoringRule, overrides: Option<bool>) -> Result<crate::models::IntegrityMonitoringRule, Error<ModifyIntegrityMonitoringRuleOnComputerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyIntegrityMonitoringRuleOnComputerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reset_integrity_monitoring_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, integrity_monitoring_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntegrityMonitoringRule, Error<ResetIntegrityMonitoringRuleOnComputerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetIntegrityMonitoringRuleOnComputerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
