...
pub fn describe_integrity_monitoring_rule_on_computer(
    ...
    Error<DescribeIntegrityMonitoringRuleOnComputerError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeIntegrityMonitoringRuleOnComputerError> =
...
pub fn list_integrity_monitoring_rules_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<
    crate::models::IntegrityMonitoringRules,
    Error<ListIntegrityMonitoringRulesOnComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntegrityMonitoringRulesOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_integrity_monitoring_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    integrity_monitoring_rule_id: i32,
    api_version: &str,
    ...
    crate::models::IntegrityMonitoringRule,
    Error<ModifyIntegrityMonitoringRuleOnComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyIntegrityMonitoringRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_integrity_monitoring_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    integrity_monitoring_rule_id: i32,
    api_version: &str,
    ...
    crate::models::IntegrityMonitoringRule,
    Error<ResetIntegrityMonitoringRuleOnComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetIntegrityMonitoringRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
