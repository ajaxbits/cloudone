...
pub async fn describe_intrusion_prevention_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, intrusion_prevention_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRule, Error<DescribeIntrusionPreventionRuleOnComputerError>> {
...
pub async fn list_intrusion_prevention_rules_on_computer(configuration: &configuration::Configuration, computer_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRules, Error<ListIntrusionPreventionRulesOnComputerError>> {
...
pub async fn modify_intrusion_prevention_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, intrusion_prevention_rule_id: i32, api_version: &str, intrusion_prevention_rule: crate::models::IntrusionPreventionRule, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRule, Error<ModifyIntrusionPreventionRuleOnComputerError>> {
...
pub async fn reset_intrusion_prevention_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, intrusion_prevention_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRule, Error<ResetIntrusionPreventionRuleOnComputerError>> {
