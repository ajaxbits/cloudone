...
pub fn describe_intrusion_prevention_rule_on_computer(
    ...
    Error<DescribeIntrusionPreventionRuleOnComputerError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeIntrusionPreventionRuleOnComputerError> =
...
pub fn list_intrusion_prevention_rules_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<
    crate::models::IntrusionPreventionRules,
    Error<ListIntrusionPreventionRulesOnComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntrusionPreventionRulesOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_intrusion_prevention_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    intrusion_prevention_rule_id: i32,
    api_version: &str,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyIntrusionPreventionRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_intrusion_prevention_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    intrusion_prevention_rule_id: i32,
    api_version: &str,
    ...
    crate::models::IntrusionPreventionRule,
    Error<ResetIntrusionPreventionRuleOnComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetIntrusionPreventionRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
