...
/// struct for typed errors of method `list_api_usage_metrics`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListApiUsageMetricsError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `search_api_usage_metrics`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchApiUsageMetricsError {
    Status403(),
    UnknownValue(serde_json::Value),
}
...
pub async fn list_api_usage_metrics(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::ApiUsageMetrics, Error<ListApiUsageMetricsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apiusagemetrics", configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListApiUsageMetricsError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn search_api_usage_metrics(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::ApiUsageMetrics, Error<SearchApiUsageMetricsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apiusagemetrics/search", configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchApiUsageMetricsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
