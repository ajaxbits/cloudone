...
pub fn create_administrator(
    ...
    api_version: &str,
    administrator: crate::models::Administrator,
) -> Result<crate::models::Administrator, Error<CreateAdministratorError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateAdministratorError> =
...
pub fn delete_administrator(
    configuration: &configuration::Configuration,
    administrator_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteAdministratorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteAdministratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_administrator(
    configuration: &configuration::Configuration,
    administrator_id: i32,
    api_version: &str,
) -> Result<crate::models::Administrator, Error<DescribeAdministratorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeAdministratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_administrators(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::Administrators, Error<ListAdministratorsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAdministratorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_administrator(
    configuration: &configuration::Configuration,
    administrator_id: i32,
    api_version: &str,
    administrator: crate::models::Administrator,
) -> Result<crate::models::Administrator, Error<ModifyAdministratorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyAdministratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_administrators(
...
) -> Result<crate::models::Administrators, Error<SearchAdministratorsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchAdministratorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
