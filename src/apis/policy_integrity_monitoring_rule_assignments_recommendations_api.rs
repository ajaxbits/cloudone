...
pub fn add_integrity_monitoring_rule_ids_to_policy(
    ...
    Error<AddIntegrityMonitoringRuleIdsToPolicyError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddIntegrityMonitoringRuleIdsToPolicyError> =
...
pub fn list_integrity_monitoring_rule_ids_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    ...
    crate::models::IntegrityMonitoringAssignments,
    Error<ListIntegrityMonitoringRuleIdsOnPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntegrityMonitoringRuleIdsOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn remove_integrity_monitoring_rule_id_from_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    ...
    crate::models::IntegrityMonitoringAssignments,
    Error<RemoveIntegrityMonitoringRuleIdFromPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveIntegrityMonitoringRuleIdFromPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn set_integrity_monitoring_rule_ids_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    ...
    crate::models::IntegrityMonitoringAssignments,
    Error<SetIntegrityMonitoringRuleIdsOnPolicyError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetIntegrityMonitoringRuleIdsOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
