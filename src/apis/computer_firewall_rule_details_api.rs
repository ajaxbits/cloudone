...
/// struct for typed errors of method `describe_firewall_rule_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DescribeFirewallRuleOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_firewall_rules_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListFirewallRulesOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `modify_firewall_rule_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModifyFirewallRuleOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `reset_firewall_rule_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ResetFirewallRuleOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}
...
pub async fn describe_firewall_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, firewall_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::FirewallRule, Error<DescribeFirewallRuleOnComputerError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/computers/{computerID}/firewall/rules/{firewallRuleID}", configuration.base_path, computerID=computer_id, firewallRuleID=firewall_rule_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeFirewallRuleOnComputerError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn list_firewall_rules_on_computer(configuration: &configuration::Configuration, computer_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::FirewallRules, Error<ListFirewallRulesOnComputerError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/computers/{computerID}/firewall/rules", configuration.base_path, computerID=computer_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFirewallRulesOnComputerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn modify_firewall_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, firewall_rule_id: i32, api_version: &str, firewall_rule: crate::models::FirewallRule, overrides: Option<bool>) -> Result<crate::models::FirewallRule, Error<ModifyFirewallRuleOnComputerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyFirewallRuleOnComputerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reset_firewall_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, firewall_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::FirewallRule, Error<ResetFirewallRuleOnComputerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetFirewallRuleOnComputerError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
