...
pub fn describe_firewall_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, firewall_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::FirewallRule, Error<DescribeFirewallRuleOnComputerError>> {
...
pub fn list_firewall_rules_on_computer(configuration: &configuration::Configuration, computer_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::FirewallRules, Error<ListFirewallRulesOnComputerError>> {
...
pub fn modify_firewall_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, firewall_rule_id: i32, api_version: &str, firewall_rule: crate::models::FirewallRule, overrides: Option<bool>) -> Result<crate::models::FirewallRule, Error<ModifyFirewallRuleOnComputerError>> {
...
pub fn reset_firewall_rule_on_computer(configuration: &configuration::Configuration, computer_id: i32, firewall_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::FirewallRule, Error<ResetFirewallRuleOnComputerError>> {
