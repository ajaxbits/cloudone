...
pub fn describe_firewall_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    firewall_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRule, Error<DescribeFirewallRuleOnComputerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeFirewallRuleOnComputerError> =
...
pub fn list_firewall_rules_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRules, Error<ListFirewallRulesOnComputerError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFirewallRulesOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_firewall_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    firewall_rule_id: i32,
    api_version: &str,
    ...
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRule, Error<ModifyFirewallRuleOnComputerError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyFirewallRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_firewall_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    firewall_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::FirewallRule, Error<ResetFirewallRuleOnComputerError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetFirewallRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
