...
pub fn describe_current_account_details(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::AccountDetails, Error<DescribeCurrentAccountDetailsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeCurrentAccountDetailsError> =
