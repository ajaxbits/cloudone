...
pub fn describe_current_account_details(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::AccountDetails, Error<DescribeCurrentAccountDetailsError>> {
