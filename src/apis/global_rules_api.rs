...
pub fn add_global_rules(
    configuration: &configuration::Configuration,
    api_version: &str,
    application_control_global_rules: crate::models::ApplicationControlGlobalRules,
) -> Result<crate::models::ApplicationControlGlobalRules, Error<AddGlobalRulesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddGlobalRulesError> =
...
pub fn describe_global_rule(
    configuration: &configuration::Configuration,
    rule_id: i64,
    api_version: &str,
) -> Result<crate::models::ApplicationControlGlobalRule, Error<DescribeGlobalRuleError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeGlobalRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_global_rules(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::ApplicationControlGlobalRules, Error<ListGlobalRulesError>> {
    let local_var_client = &configuration.client;
...
pub fn modify_global_rule(
    configuration: &configuration::Configuration,
    rule_id: i64,
    api_version: &str,
    application_control_global_rule: crate::models::ApplicationControlGlobalRule,
) -> Result<crate::models::ApplicationControlGlobalRule, Error<ModifyGlobalRuleError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyGlobalRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_global_rules(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::ApplicationControlGlobalRules, Error<SearchGlobalRulesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchGlobalRulesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
