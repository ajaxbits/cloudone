...
pub fn describe_log_inspection_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    log_inspection_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::LogInspectionRule, Error<DescribeLogInspectionRuleOnComputerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeLogInspectionRuleOnComputerError> =
...
pub fn list_log_inspection_rules_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::LogInspectionRules, Error<ListLogInspectionRulesOnComputerError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListLogInspectionRulesOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_log_inspection_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    log_inspection_rule_id: i32,
    api_version: &str,
    ...
    overrides: Option<bool>,
) -> Result<crate::models::LogInspectionRule, Error<ModifyLogInspectionRuleOnComputerError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyLogInspectionRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_log_inspection_rule_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    log_inspection_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::LogInspectionRule, Error<ResetLogInspectionRuleOnComputerError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetLogInspectionRuleOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
