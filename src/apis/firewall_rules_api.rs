...
pub async fn create_firewall_rule(configuration: &configuration::Configuration, api_version: &str, firewall_rule: crate::models::FirewallRule) -> Result<crate::models::FirewallRule, Error<CreateFirewallRuleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateFirewallRuleError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_firewall_rule(configuration: &configuration::Configuration, firewall_rule_id: i32, api_version: &str) -> Result<(), Error<DeleteFirewallRuleError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/firewallrules/{firewallRuleID}", configuration.base_path, firewallRuleID=firewall_rule_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteFirewallRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn describe_firewall_rule(configuration: &configuration::Configuration, firewall_rule_id: i32, api_version: &str) -> Result<crate::models::FirewallRule, Error<DescribeFirewallRuleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeFirewallRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_firewall_rules(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::FirewallRules, Error<ListFirewallRulesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFirewallRulesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn modify_firewall_rule(configuration: &configuration::Configuration, firewall_rule_id: i32, api_version: &str, firewall_rule: crate::models::FirewallRule) -> Result<crate::models::FirewallRule, Error<ModifyFirewallRuleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyFirewallRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_firewall_rules(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::FirewallRules, Error<SearchFirewallRulesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchFirewallRulesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
