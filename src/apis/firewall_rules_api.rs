...
pub fn create_firewall_rule(configuration: &configuration::Configuration, api_version: &str, firewall_rule: crate::models::FirewallRule) -> Result<crate::models::FirewallRule, Error<CreateFirewallRuleError>> {
...
pub fn delete_firewall_rule(configuration: &configuration::Configuration, firewall_rule_id: i32, api_version: &str) -> Result<(), Error<DeleteFirewallRuleError>> {
...
pub fn describe_firewall_rule(configuration: &configuration::Configuration, firewall_rule_id: i32, api_version: &str) -> Result<crate::models::FirewallRule, Error<DescribeFirewallRuleError>> {
...
pub fn list_firewall_rules(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::FirewallRules, Error<ListFirewallRulesError>> {
...
pub fn modify_firewall_rule(configuration: &configuration::Configuration, firewall_rule_id: i32, api_version: &str, firewall_rule: crate::models::FirewallRule) -> Result<crate::models::FirewallRule, Error<ModifyFirewallRuleError>> {
...
pub fn search_firewall_rules(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::FirewallRules, Error<SearchFirewallRulesError>> {
