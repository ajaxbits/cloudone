...
pub fn add_integrity_monitoring_rule_ids_to_computer(configuration: &configuration::Configuration, computer_id: i32, api_version: &str, overrides: Option<bool>, rule_ids: Option<crate::models::RuleIds>) -> Result<crate::models::IntegrityMonitoringAssignments, Error<AddIntegrityMonitoringRuleIdsToComputerError>> {
...
pub fn list_integrity_monitoring_rule_ids_on_computer(configuration: &configuration::Configuration, computer_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntegrityMonitoringAssignments, Error<ListIntegrityMonitoringRuleIdsOnComputerError>> {
...
pub fn remove_integrity_monitoring_rule_id_from_computer(configuration: &configuration::Configuration, computer_id: i32, integrity_monitoring_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntegrityMonitoringAssignments, Error<RemoveIntegrityMonitoringRuleIdFromComputerError>> {
...
pub fn set_integrity_monitoring_rule_ids_on_computer(configuration: &configuration::Configuration, computer_id: i32, api_version: &str, overrides: Option<bool>, rule_ids: Option<crate::models::RuleIds>) -> Result<crate::models::IntegrityMonitoringAssignments, Error<SetIntegrityMonitoringRuleIdsOnComputerError>> {
