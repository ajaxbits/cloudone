...
pub fn create_common_object_import_task(
    configuration: &configuration::Configuration,
    api_version: &str,
    common_object_import_task: Option<crate::models::CommonObjectImportTask>,
) -> Result<crate::models::CommonObjectImportTask, Error<CreateCommonObjectImportTaskError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateCommonObjectImportTaskError> =
...
pub fn describe_common_object_import_task(
    configuration: &configuration::Configuration,
    common_object_import_task_id: i32,
    api_version: &str,
) -> Result<crate::models::CommonObjectImportTask, Error<DescribeCommonObjectImportTaskError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/commonobjectimporttasks/{commonObjectImportTaskID}",
        configuration.base_path,
        commonObjectImportTaskID = common_object_import_task_id
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeCommonObjectImportTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_common_object_import_tasks(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::CommonObjectImportTasks, Error<ListCommonObjectImportTasksError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListCommonObjectImportTasksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_common_object_import_tasks(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::CommonObjectImportTasks, Error<SearchCommonObjectImportTasksError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchCommonObjectImportTasksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
