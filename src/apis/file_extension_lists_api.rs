...
pub fn create_file_extension_list(configuration: &configuration::Configuration, api_version: &str, file_extension_list: crate::models::FileExtensionList) -> Result<crate::models::FileExtensionList, Error<CreateFileExtensionListError>> {
...
pub fn delete_file_extension_list(configuration: &configuration::Configuration, file_extension_list_id: i32, api_version: &str) -> Result<(), Error<DeleteFileExtensionListError>> {
...
pub fn describe_file_extension_list(configuration: &configuration::Configuration, file_extension_list_id: i32, api_version: &str) -> Result<crate::models::FileExtensionList, Error<DescribeFileExtensionListError>> {
...
pub fn list_file_extension_lists(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::FileExtensionLists, Error<ListFileExtensionListsError>> {
...
pub fn modify_file_extension_list(configuration: &configuration::Configuration, file_extension_list_id: i32, api_version: &str, file_extension_list: crate::models::FileExtensionList) -> Result<crate::models::FileExtensionList, Error<ModifyFileExtensionListError>> {
...
pub fn search_file_extension_lists(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::FileExtensionLists, Error<SearchFileExtensionListsError>> {
