...
pub fn create_interface_type(
    ...
    policy_id: i32,
    api_version: &str,
    interface_type: Option<crate::models::InterfaceType>,
) -> Result<crate::models::InterfaceType, Error<CreateInterfaceTypeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateInterfaceTypeError> =
...
pub fn delete_interface_type(
    configuration: &configuration::Configuration,
    policy_id: i32,
    interface_type_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteInterfaceTypeError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteInterfaceTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_interface_type(
    configuration: &configuration::Configuration,
    policy_id: i32,
    interface_type_id: i32,
    api_version: &str,
) -> Result<crate::models::InterfaceType, Error<DescribeInterfaceTypeError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeInterfaceTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_interface_types(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
) -> Result<crate::models::InterfaceTypes, Error<ListInterfaceTypesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListInterfaceTypesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_interface_type(
    configuration: &configuration::Configuration,
    policy_id: i32,
    interface_type_id: i32,
    api_version: &str,
    interface_type: crate::models::InterfaceType,
) -> Result<crate::models::InterfaceType, Error<ModifyInterfaceTypeError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyInterfaceTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_interface_types(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::InterfaceTypes, Error<SearchInterfaceTypesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchInterfaceTypesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
