...
pub fn create_policy_import_task(
    configuration: &configuration::Configuration,
    api_version: &str,
    policy_import_task: Option<crate::models::PolicyImportTask>,
) -> Result<crate::models::PolicyImportTask, Error<CreatePolicyImportTaskError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePolicyImportTaskError> =
...
pub fn describe_policy_import_task(
    configuration: &configuration::Configuration,
    policy_import_task_id: i32,
    api_version: &str,
) -> Result<crate::models::PolicyImportTask, Error<DescribePolicyImportTaskError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/policyimporttasks/{policyImportTaskID}",
        configuration.base_path,
        policyImportTaskID = policy_import_task_id
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribePolicyImportTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_policy_import_tasks(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::PolicyImportTasks, Error<ListPolicyImportTasksError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPolicyImportTasksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_policy_import_tasks(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::PolicyImportTasks, Error<SearchPolicyImportTasksError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchPolicyImportTasksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
