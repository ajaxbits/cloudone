...
pub fn create_v_center_connector(
    configuration: &configuration::Configuration,
    api_version: &str,
    v_center_connector: crate::models::VCenterConnector,
) -> Result<crate::models::VCenterConnector, Error<CreateVCenterConnectorError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateVCenterConnectorError> =
...
pub fn delete_v_center_connector(
    configuration: &configuration::Configuration,
    virtual_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteVCenterConnectorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteVCenterConnectorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_v_center_connector(
    configuration: &configuration::Configuration,
    virtual_id: i32,
    api_version: &str,
) -> Result<crate::models::VCenterConnector, Error<DescribeVCenterConnectorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeVCenterConnectorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_v_center_connectors(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::VCenterConnectors, Error<ListVCenterConnectorsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListVCenterConnectorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_v_center_connector(
    configuration: &configuration::Configuration,
    virtual_id: i32,
    api_version: &str,
    v_center_connector: Option<crate::models::VCenterConnector>,
) -> Result<crate::models::VCenterConnector, Error<ModifyVCenterConnectorError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyVCenterConnectorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
