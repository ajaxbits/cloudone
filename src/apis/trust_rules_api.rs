...
pub fn create_trust_rule(
    configuration: &configuration::Configuration,
    api_version: &str,
    application_control_trust_rule: crate::models::ApplicationControlTrustRule,
) -> Result<crate::models::ApplicationControlTrustRule, Error<CreateTrustRuleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateTrustRuleError> =
...
pub fn delete_trust_rule(
    configuration: &configuration::Configuration,
    ac_trust_rule_id: i64,
    api_version: &str,
) -> Result<(), Error<DeleteTrustRuleError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteTrustRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_trust_rule(
    configuration: &configuration::Configuration,
    ac_trust_rule_id: i64,
    api_version: &str,
) -> Result<crate::models::ApplicationControlTrustRule, Error<DescribeTrustRuleError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeTrustRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_trust_rules(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::TrustRules, Error<ListTrustRulesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListTrustRulesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_trust_rule(
    configuration: &configuration::Configuration,
    ac_trust_rule_id: i64,
    api_version: &str,
    trust_rule_update_request: crate::models::TrustRuleUpdateRequest,
) -> Result<crate::models::ApplicationControlTrustRule, Error<ModifyTrustRuleError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyTrustRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
