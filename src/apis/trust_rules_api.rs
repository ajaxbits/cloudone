...
/// struct for typed errors of method `create_trust_rule`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateTrustRuleError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `delete_trust_rule`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteTrustRuleError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `describe_trust_rule`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DescribeTrustRuleError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_trust_rules`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListTrustRulesError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `modify_trust_rule`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModifyTrustRuleError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_trust_rule(configuration: &configuration::Configuration, api_version: &str, application_control_trust_rule: crate::models::ApplicationControlTrustRule) -> Result<crate::models::ApplicationControlTrustRule, Error<CreateTrustRuleError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/applicationcontroltrustrules", configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&application_control_trust_rule);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateTrustRuleError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_trust_rule(configuration: &configuration::Configuration, ac_trust_rule_id: i64, api_version: &str) -> Result<(), Error<DeleteTrustRuleError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/applicationcontroltrustrules/{acTrustRuleID}", configuration.base_path, acTrustRuleID=ac_trust_rule_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteTrustRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn describe_trust_rule(configuration: &configuration::Configuration, ac_trust_rule_id: i64, api_version: &str) -> Result<crate::models::ApplicationControlTrustRule, Error<DescribeTrustRuleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeTrustRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_trust_rules(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::TrustRules, Error<ListTrustRulesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListTrustRulesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn modify_trust_rule(configuration: &configuration::Configuration, ac_trust_rule_id: i64, api_version: &str, trust_rule_update_request: crate::models::TrustRuleUpdateRequest) -> Result<crate::models::ApplicationControlTrustRule, Error<ModifyTrustRuleError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&trust_rule_update_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyTrustRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
