...
pub async fn describe_intrusion_prevention_rule_on_policy(configuration: &configuration::Configuration, policy_id: i32, intrusion_prevention_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRule, Error<DescribeIntrusionPreventionRuleOnPolicyError>> {
...
pub async fn list_intrusion_prevention_rules_on_policy(configuration: &configuration::Configuration, policy_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRules, Error<ListIntrusionPreventionRulesOnPolicyError>> {
...
pub async fn modify_intrusion_prevention_rule_on_policy(configuration: &configuration::Configuration, policy_id: i32, intrusion_prevention_rule_id: i32, api_version: &str, intrusion_prevention_rule: crate::models::IntrusionPreventionRule, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRule, Error<ModifyIntrusionPreventionRuleOnPolicyError>> {
...
pub async fn reset_intrusion_prevention_rule_on_policy(configuration: &configuration::Configuration, policy_id: i32, intrusion_prevention_rule_id: i32, api_version: &str, overrides: Option<bool>) -> Result<crate::models::IntrusionPreventionRule, Error<ResetIntrusionPreventionRuleOnPolicyError>> {
