...
pub fn describe_intrusion_prevention_rule_on_policy(
    ...
    Error<DescribeIntrusionPreventionRuleOnPolicyError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeIntrusionPreventionRuleOnPolicyError> =
...
pub fn list_intrusion_prevention_rules_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::IntrusionPreventionRules, Error<ListIntrusionPreventionRulesOnPolicyError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIntrusionPreventionRulesOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_intrusion_prevention_rule_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    intrusion_prevention_rule_id: i32,
    api_version: &str,
    ...
    overrides: Option<bool>,
) -> Result<crate::models::IntrusionPreventionRule, Error<ModifyIntrusionPreventionRuleOnPolicyError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyIntrusionPreventionRuleOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn reset_intrusion_prevention_rule_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    intrusion_prevention_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::IntrusionPreventionRule, Error<ResetIntrusionPreventionRuleOnPolicyError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetIntrusionPreventionRuleOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
