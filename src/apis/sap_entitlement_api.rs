...
pub fn create_or_update_sap_entitlement(configuration: &configuration::Configuration, api_version: &str, sap: Option<crate::models::Sap>) -> Result<crate::models::Sap, Error<CreateOrUpdateSapEntitlementError>> {
