...
pub fn create_or_update_sap_entitlement(
    configuration: &configuration::Configuration,
    api_version: &str,
    sap: Option<crate::models::Sap>,
) -> Result<crate::models::Sap, Error<CreateOrUpdateSapEntitlementError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateOrUpdateSapEntitlementError> =
