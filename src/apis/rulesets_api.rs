...
pub async fn create_ruleset(configuration: &configuration::Configuration, softwareinventoryid: i64, api_version: &str, ruleset: crate::models::Ruleset) -> Result<crate::models::Ruleset, Error<CreateRulesetError>> {
...
pub async fn delete_ruleset(configuration: &configuration::Configuration, ruleset_id: i64, api_version: &str) -> Result<(), Error<DeleteRulesetError>> {
...
pub async fn delete_ruleset_rule(configuration: &configuration::Configuration, ruleset_id: i64, rule_id: i64, api_version: &str) -> Result<(), Error<DeleteRulesetRuleError>> {
...
pub async fn describe_ruleset(configuration: &configuration::Configuration, ruleset_id: i64, api_version: &str) -> Result<crate::models::Ruleset, Error<DescribeRulesetError>> {
...
pub async fn describe_ruleset_rule(configuration: &configuration::Configuration, ruleset_id: i64, rule_id: i64, api_version: &str) -> Result<crate::models::ApplicationControlRule, Error<DescribeRulesetRuleError>> {
...
pub async fn list_ruleset_rules(configuration: &configuration::Configuration, ruleset_id: i64, api_version: &str) -> Result<crate::models::ApplicationControlRules, Error<ListRulesetRulesError>> {
...
pub async fn list_rulesets(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::Rulesets, Error<ListRulesetsError>> {
...
pub async fn modify_ruleset_rule(configuration: &configuration::Configuration, ruleset_id: i64, rule_id: i64, api_version: &str, application_control_rule: crate::models::ApplicationControlRule) -> Result<crate::models::ApplicationControlRule, Error<ModifyRulesetRuleError>> {
...
pub async fn search_ruleset_rules(configuration: &configuration::Configuration, ruleset_id: i64, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::ApplicationControlRules, Error<SearchRulesetRulesError>> {
...
pub async fn search_rulesets(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::Rulesets, Error<SearchRulesetsError>> {
