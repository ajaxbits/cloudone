...
pub async fn create_file_list(configuration: &configuration::Configuration, api_version: &str, file_list: crate::models::FileList) -> Result<crate::models::FileList, Error<CreateFileListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateFileListError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_file_list(configuration: &configuration::Configuration, file_list_id: i32, api_version: &str) -> Result<(), Error<DeleteFileListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/filelists/{fileListID}", configuration.base_path, fileListID=file_list_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteFileListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn describe_file_list(configuration: &configuration::Configuration, file_list_id: i32, api_version: &str) -> Result<crate::models::FileList, Error<DescribeFileListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeFileListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_file_lists(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::FileLists, Error<ListFileListsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFileListsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn modify_file_list(configuration: &configuration::Configuration, file_list_id: i32, api_version: &str, file_list: crate::models::FileList) -> Result<crate::models::FileList, Error<ModifyFileListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyFileListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_file_lists(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::FileLists, Error<SearchFileListsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchFileListsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
