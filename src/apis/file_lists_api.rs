...
pub fn create_file_list(configuration: &configuration::Configuration, api_version: &str, file_list: crate::models::FileList) -> Result<crate::models::FileList, Error<CreateFileListError>> {
...
pub fn delete_file_list(configuration: &configuration::Configuration, file_list_id: i32, api_version: &str) -> Result<(), Error<DeleteFileListError>> {
...
pub fn describe_file_list(configuration: &configuration::Configuration, file_list_id: i32, api_version: &str) -> Result<crate::models::FileList, Error<DescribeFileListError>> {
...
pub fn list_file_lists(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::FileLists, Error<ListFileListsError>> {
...
pub fn modify_file_list(configuration: &configuration::Configuration, file_list_id: i32, api_version: &str, file_list: crate::models::FileList) -> Result<crate::models::FileList, Error<ModifyFileListError>> {
...
pub fn search_file_lists(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::FileLists, Error<SearchFileListsError>> {
