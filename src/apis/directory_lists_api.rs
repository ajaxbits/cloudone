...
/// struct for typed errors of method `create_directory_list`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateDirectoryListError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `delete_directory_list`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteDirectoryListError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `describe_directory_list`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DescribeDirectoryListError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_directory_lists`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListDirectoryListsError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `modify_directory_list`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModifyDirectoryListError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `search_directory_lists`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchDirectoryListsError {
    Status403(),
    UnknownValue(serde_json::Value),
}
...
pub fn create_directory_list(
    configuration: &configuration::Configuration,
    api_version: &str,
    directory_list: crate::models::DirectoryList,
) -> Result<crate::models::DirectoryList, Error<CreateDirectoryListError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/directorylists", configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDirectoryListError> =
...
pub fn delete_directory_list(
    configuration: &configuration::Configuration,
    directory_list_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteDirectoryListError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/directorylists/{directoryListID}",
        configuration.base_path,
        directoryListID = directory_list_id
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteDirectoryListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_directory_list(
    configuration: &configuration::Configuration,
    directory_list_id: i32,
    api_version: &str,
) -> Result<crate::models::DirectoryList, Error<DescribeDirectoryListError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeDirectoryListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_directory_lists(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::DirectoryLists, Error<ListDirectoryListsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListDirectoryListsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_directory_list(
    configuration: &configuration::Configuration,
    directory_list_id: i32,
    api_version: &str,
    directory_list: crate::models::DirectoryList,
) -> Result<crate::models::DirectoryList, Error<ModifyDirectoryListError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyDirectoryListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_directory_lists(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::DirectoryLists, Error<SearchDirectoryListsError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/directorylists/search", configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchDirectoryListsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
