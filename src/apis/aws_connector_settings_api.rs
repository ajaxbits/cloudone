...
pub async fn list_aws_connector_settings(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::Awsconnectorsettings, Error<ListAwsConnectorSettingsError>> {
