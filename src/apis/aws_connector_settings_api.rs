...
pub fn list_aws_connector_settings(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::Awsconnectorsettings, Error<ListAwsConnectorSettingsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAwsConnectorSettingsError> =
