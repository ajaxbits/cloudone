...
pub async fn create_gcp_connector(configuration: &configuration::Configuration, api_version: &str, gcp_connector: crate::models::GcpConnector) -> Result<crate::models::GcpConnector, Error<CreateGcpConnectorError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateGcpConnectorError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_gcp_connector(configuration: &configuration::Configuration, gcp_connector_id: i32, api_version: &str) -> Result<(), Error<DeleteGcpConnectorError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/gcpconnectors/{gcpConnectorID}", configuration.base_path, gcpConnectorID=gcp_connector_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteGcpConnectorError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn describe_gcp_connector(configuration: &configuration::Configuration, gcp_connector_id: i32, api_version: &str) -> Result<crate::models::GcpConnector, Error<DescribeGcpConnectorError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeGcpConnectorError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_gcp_connectors(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::GcpConnectors, Error<ListGcpConnectorsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListGcpConnectorsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn modify_gcp_connector(configuration: &configuration::Configuration, gcp_connector_id: i32, api_version: &str, gcp_connector: Option<crate::models::GcpConnector>) -> Result<crate::models::GcpConnector, Error<ModifyGcpConnectorError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyGcpConnectorError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_gcp_connectors(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::GcpConnectors, Error<SearchGcpConnectorsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchGcpConnectorsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
