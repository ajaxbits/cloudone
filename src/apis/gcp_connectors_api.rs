...
pub fn create_gcp_connector(configuration: &configuration::Configuration, api_version: &str, gcp_connector: crate::models::GcpConnector) -> Result<crate::models::GcpConnector, Error<CreateGcpConnectorError>> {
...
pub fn delete_gcp_connector(configuration: &configuration::Configuration, gcp_connector_id: i32, api_version: &str) -> Result<(), Error<DeleteGcpConnectorError>> {
...
pub fn describe_gcp_connector(configuration: &configuration::Configuration, gcp_connector_id: i32, api_version: &str) -> Result<crate::models::GcpConnector, Error<DescribeGcpConnectorError>> {
...
pub fn list_gcp_connectors(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::GcpConnectors, Error<ListGcpConnectorsError>> {
...
pub fn modify_gcp_connector(configuration: &configuration::Configuration, gcp_connector_id: i32, api_version: &str, gcp_connector: Option<crate::models::GcpConnector>) -> Result<crate::models::GcpConnector, Error<ModifyGcpConnectorError>> {
...
pub fn search_gcp_connectors(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::GcpConnectors, Error<SearchGcpConnectorsError>> {
