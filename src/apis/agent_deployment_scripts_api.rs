...
pub fn generate_agent_deployment_script(
    configuration: &configuration::Configuration,
    api_version: &str,
    agent_deployment_script: Option<crate::models::AgentDeploymentScript>,
) -> Result<crate::models::AgentDeploymentScript, Error<GenerateAgentDeploymentScriptError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GenerateAgentDeploymentScriptError> =
