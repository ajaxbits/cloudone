...
pub fn generate_agent_deployment_script(configuration: &configuration::Configuration, api_version: &str, agent_deployment_script: Option<crate::models::AgentDeploymentScript>) -> Result<crate::models::AgentDeploymentScript, Error<GenerateAgentDeploymentScriptError>> {
