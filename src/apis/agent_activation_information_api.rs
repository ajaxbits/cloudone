...
pub fn describe_agent_activation_information(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::AgentActivationInformation, Error<DescribeAgentActivationInformationError>> {
