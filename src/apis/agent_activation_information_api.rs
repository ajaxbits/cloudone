...
/// struct for typed errors of method `describe_agent_activation_information`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DescribeAgentActivationInformationError {
    Status403(),
...
pub async fn describe_agent_activation_information(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::AgentActivationInformation, Error<DescribeAgentActivationInformationError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/agentactivationinformation", configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeAgentActivationInformationError> = serde_json::from_str(&local_var_content).ok();
