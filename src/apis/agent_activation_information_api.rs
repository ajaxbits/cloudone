...
pub fn describe_agent_activation_information(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::AgentActivationInformation, Error<DescribeAgentActivationInformationError>>
{
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeAgentActivationInformationError> =
