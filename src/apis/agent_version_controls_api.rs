...
pub fn describe_agent_version_control(
    configuration: &configuration::Configuration,
    agent_version_control_profile_id: i32,
    agent_version_control_id: i32,
    api_version: &str,
) -> Result<crate::models::AgentVersionControl, Error<DescribeAgentVersionControlError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeAgentVersionControlError> =
...
pub fn list_agent_version_controls(
    configuration: &configuration::Configuration,
    agent_version_control_profile_id: i32,
    api_version: &str,
) -> Result<crate::models::AgentVersionControls, Error<ListAgentVersionControlsError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/agentversioncontrolprofiles/{agentVersionControlProfileID}/agentversioncontrols",
        configuration.base_path,
        agentVersionControlProfileID = agent_version_control_profile_id
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAgentVersionControlsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_agent_version_controls(
    configuration: &configuration::Configuration,
    agent_version_control_profile_id: i32,
    api_version: &str,
    agent_version_controls: crate::models::AgentVersionControls,
) -> Result<crate::models::AgentVersionControls, Error<ModifyAgentVersionControlsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyAgentVersionControlsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_agent_version_controls(
    configuration: &configuration::Configuration,
    agent_version_control_profile_id: i32,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::AgentVersionControls, Error<SearchAgentVersionControlsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchAgentVersionControlsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
