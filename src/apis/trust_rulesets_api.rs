...
pub fn add_trust_rules(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    api_version: &str,
    rule_long_ids: crate::models::RuleLongIds,
) -> Result<crate::models::TrustRuleIds, Error<AddTrustRulesError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/applicationcontroltrustrulesets/{acTrustRulesetID}/rules",
        configuration.base_path,
        acTrustRulesetID = ac_trust_ruleset_id
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddTrustRulesError> =
...
pub fn create_trust_ruleset(
    configuration: &configuration::Configuration,
    api_version: &str,
    trust_ruleset: crate::models::TrustRuleset,
) -> Result<crate::models::TrustRuleset, Error<CreateTrustRulesetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateTrustRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn delete_trust_rule_from_trust_ruleset(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    ac_trust_rule_id: i64,
    api_version: &str,
) -> Result<(), Error<DeleteTrustRuleFromTrustRulesetError>> {
    let local_var_client = &configuration.client;
    ...
    let local_var_uri_str = format!(
        ...
        configuration.base_path,
        acTrustRulesetID = ac_trust_ruleset_id,
        acTrustRuleID = ac_trust_rule_id
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteTrustRuleFromTrustRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn delete_trust_ruleset(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    api_version: &str,
) -> Result<(), Error<DeleteTrustRulesetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteTrustRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_trust_ruleset(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    api_version: &str,
) -> Result<crate::models::TrustRuleset, Error<DescribeTrustRulesetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeTrustRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_trust_ruleset_assignments(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    api_version: &str,
) -> Result<crate::models::TrustRulesetAssignments, Error<ListTrustRulesetAssignmentsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListTrustRulesetAssignmentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_trust_ruleset_rules(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    api_version: &str,
) -> Result<crate::models::TrustRules, Error<ListTrustRulesetRulesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListTrustRulesetRulesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_trust_rulesets(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::TrustRulesets, Error<ListTrustRulesetsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListTrustRulesetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_trust_ruleset(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    api_version: &str,
    trust_ruleset_update_request: crate::models::TrustRulesetUpdateRequest,
) -> Result<crate::models::TrustRuleset, Error<ModifyTrustRulesetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyTrustRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn set_trust_rules(
    configuration: &configuration::Configuration,
    ac_trust_ruleset_id: i64,
    api_version: &str,
    rule_long_ids: crate::models::RuleLongIds,
) -> Result<crate::models::TrustRuleIds, Error<SetTrustRulesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetTrustRulesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
