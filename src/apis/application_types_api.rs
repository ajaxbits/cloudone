...
pub fn create_application_type(configuration: &configuration::Configuration, api_version: &str, application_type: crate::models::ApplicationType) -> Result<crate::models::ApplicationType, Error<CreateApplicationTypeError>> {
...
pub fn delete_application_type(configuration: &configuration::Configuration, application_type_id: i32, api_version: &str) -> Result<(), Error<DeleteApplicationTypeError>> {
...
pub fn describe_application_type(configuration: &configuration::Configuration, application_type_id: i32, api_version: &str) -> Result<crate::models::ApplicationType, Error<DescribeApplicationTypeError>> {
...
pub fn list_application_types(configuration: &configuration::Configuration, api_version: &str) -> Result<crate::models::ApplicationTypes, Error<ListApplicationTypesError>> {
...
pub fn modify_application_type(configuration: &configuration::Configuration, application_type_id: i32, api_version: &str, application_type: crate::models::ApplicationType) -> Result<crate::models::ApplicationType, Error<ModifyApplicationTypeError>> {
...
pub fn search_application_types(configuration: &configuration::Configuration, api_version: &str, search_filter: Option<crate::models::SearchFilter>) -> Result<crate::models::ApplicationTypes, Error<SearchApplicationTypesError>> {
