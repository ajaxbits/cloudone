...
pub fn create_application_type(
    configuration: &configuration::Configuration,
    api_version: &str,
    application_type: crate::models::ApplicationType,
) -> Result<crate::models::ApplicationType, Error<CreateApplicationTypeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateApplicationTypeError> =
...
pub fn delete_application_type(
    configuration: &configuration::Configuration,
    application_type_id: i32,
    api_version: &str,
) -> Result<(), Error<DeleteApplicationTypeError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteApplicationTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn describe_application_type(
    configuration: &configuration::Configuration,
    application_type_id: i32,
    api_version: &str,
) -> Result<crate::models::ApplicationType, Error<DescribeApplicationTypeError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeApplicationTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn list_application_types(
    configuration: &configuration::Configuration,
    api_version: &str,
) -> Result<crate::models::ApplicationTypes, Error<ListApplicationTypesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListApplicationTypesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn modify_application_type(
    configuration: &configuration::Configuration,
    application_type_id: i32,
    api_version: &str,
    application_type: crate::models::ApplicationType,
) -> Result<crate::models::ApplicationType, Error<ModifyApplicationTypeError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ModifyApplicationTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn search_application_types(
    configuration: &configuration::Configuration,
    api_version: &str,
    search_filter: Option<crate::models::SearchFilter>,
) -> Result<crate::models::ApplicationTypes, Error<SearchApplicationTypesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchApplicationTypesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
