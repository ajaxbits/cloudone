...
pub fn add_log_inspection_rule_ids_to_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    rule_ids: Option<crate::models::RuleIds>,
) -> Result<crate::models::LogInspectionAssignments, Error<AddLogInspectionRuleIdsToPolicyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddLogInspectionRuleIdsToPolicyError> =
...
pub fn list_log_inspection_rule_ids_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::LogInspectionAssignments, Error<ListLogInspectionRuleIdsOnPolicyError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListLogInspectionRuleIdsOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn remove_log_inspection_rule_id_from_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    log_inspection_rule_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::LogInspectionAssignments, Error<RemoveLogInspectionRuleIdFromPolicyError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveLogInspectionRuleIdFromPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn set_log_inspection_rule_ids_on_policy(
    configuration: &configuration::Configuration,
    policy_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    rule_ids: Option<crate::models::RuleIds>,
) -> Result<crate::models::LogInspectionAssignments, Error<SetLogInspectionRuleIdsOnPolicyError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetLogInspectionRuleIdsOnPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
