...
/// struct for typed errors of method `add_log_inspection_rule_ids_to_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddLogInspectionRuleIdsToComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_log_inspection_rule_ids_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListLogInspectionRuleIdsOnComputerError {
    Status403(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `remove_log_inspection_rule_id_from_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveLogInspectionRuleIdFromComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `set_log_inspection_rule_ids_on_computer`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetLogInspectionRuleIdsOnComputerError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}
...
pub fn add_log_inspection_rule_ids_to_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    rule_ids: Option<crate::models::RuleIds>,
) -> Result<crate::models::LogInspectionAssignments, Error<AddLogInspectionRuleIdsToComputerError>>
{
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddLogInspectionRuleIdsToComputerError> =
...
pub fn list_log_inspection_rule_ids_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
) -> Result<crate::models::LogInspectionAssignments, Error<ListLogInspectionRuleIdsOnComputerError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListLogInspectionRuleIdsOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn remove_log_inspection_rule_id_from_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    ...
    crate::models::LogInspectionAssignments,
    Error<RemoveLogInspectionRuleIdFromComputerError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveLogInspectionRuleIdFromComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn set_log_inspection_rule_ids_on_computer(
    configuration: &configuration::Configuration,
    computer_id: i32,
    api_version: &str,
    overrides: Option<bool>,
    rule_ids: Option<crate::models::RuleIds>,
) -> Result<crate::models::LogInspectionAssignments, Error<SetLogInspectionRuleIdsOnComputerError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetLogInspectionRuleIdsOnComputerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
