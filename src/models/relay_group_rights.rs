...
pub struct RelayGroupRights {
    ...
    #[serde(rename = "canCreateNewRelayGroups", skip_serializing_if = "Option::is_none")]
    pub can_create_new_relay_groups: Option<bool>,
    /// Right to delete relay groups.
    #[serde(rename = "canDeleteRelayGroups", skip_serializing_if = "Option::is_none")]
    pub can_delete_relay_groups: Option<bool>,
    /// Right to edit relay group properties.
    #[serde(rename = "canEditRelayGroupProperties", skip_serializing_if = "Option::is_none")]
