...
/// ActivityMonitoringPolicyExtension : Policy-level configuration for the Activity Monitoring module



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ActivityMonitoringPolicyExtension {
...
impl ActivityMonitoringPolicyExtension {
    /// Policy-level configuration for the Activity Monitoring module
    pub fn new() -> ActivityMonitoringPolicyExtension {
