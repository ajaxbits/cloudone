...
pub struct FirewallRule {
    ...
    #[serde(rename = "destinationIPRangeFrom", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationIPRangeTo", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationIPMultiple", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationIPListID", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationMACValue", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationMACMultiple", skip_serializing_if = "Option::is_none")]
    pub destination_mac_multiple: Option<Vec<String>>,
    /// ID of MAC address list. Only applies to MAC type \"mac-list\". Set to 0 to remove any assignment. Searchable as Numeric.
    #[serde(rename = "destinationMACListID", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationPortType", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationPortMultiple", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "destinationPortListID", skip_serializing_if = "Option::is_none")]
