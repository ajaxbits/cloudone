...
pub struct ScheduledTask {
    ...
    #[serde(
        rename = "scanForOpenPortsTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub scan_for_open_ports_task_parameters:
        Option<Box<crate::models::ScanForOpenPortsTaskParameters>>,
    #[serde(
        rename = "sendAlertSummaryTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub send_alert_summary_task_parameters:
        Option<Box<crate::models::SendAlertSummaryTaskParameters>>,
    #[serde(
        rename = "discoverComputersTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub discover_computers_task_parameters:
        Option<Box<crate::models::DiscoverComputersTaskParameters>>,
    #[serde(
        rename = "runScriptTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub run_script_task_parameters: Option<Box<crate::models::RunScriptTaskParameters>>,
    #[serde(
        rename = "sendPolicyTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub send_policy_task_parameters: Option<Box<crate::models::SendPolicyTaskParameters>>,
    #[serde(
        rename = "generateReportTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub generate_report_task_parameters: Option<Box<crate::models::GenerateReportTaskParameters>>,
    #[serde(
        rename = "synchronizeDirectoryTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub synchronize_directory_task_parameters:
        Option<Box<crate::models::SynchronizeDirectoryTaskParameters>>,
    #[serde(
        rename = "scanForRecommendationsTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub scan_for_recommendations_task_parameters:
        Option<Box<crate::models::ScanForRecommendationsTaskParameters>>,
    #[serde(
        rename = "synchronizeVCenterTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub synchronize_v_center_task_parameters:
        Option<Box<crate::models::SynchronizeVCenterTaskParameters>>,
    #[serde(
        rename = "scanForIntegrityChangesTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub scan_for_integrity_changes_task_parameters:
        Option<Box<crate::models::ScanForIntegrityChangesTaskParameters>>,
    #[serde(
        rename = "scanForMalwareTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub scan_for_malware_task_parameters: Option<Box<crate::models::ScanForMalwareTaskParameters>>,
    #[serde(
        rename = "checkForSecurityUpdatesTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub check_for_security_updates_task_parameters:
        Option<Box<crate::models::CheckForSecurityUpdatesTaskParameters>>,
    #[serde(
        rename = "synchronizeCloudAccountTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub synchronize_cloud_account_task_parameters:
        Option<Box<crate::models::SynchronizeCloudAccountTaskParameters>>,
    #[serde(
        rename = "updateSuspiciousObjectsListTaskParameters",
        skip_serializing_if = "Option::is_none"
    )]
    pub update_suspicious_objects_list_task_parameters:
        Option<Box<crate::models::UpdateSuspiciousObjectsListTaskParameters>>,
