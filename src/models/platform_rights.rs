...
pub struct PlatformRights {
    ...
    #[serde(
        rename = "dataCenterGatewayRights",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "samlidentityProviderRights",
        skip_serializing_if = "Option::is_none"
    )]
