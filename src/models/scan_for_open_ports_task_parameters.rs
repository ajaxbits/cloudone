...
/// ScanForOpenPortsTaskParameters : Controls the behavior of a scheduled task of type scan-for-open-ports.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScanForOpenPortsTaskParameters {
    #[serde(rename = "computerFilter", skip_serializing_if = "Option::is_none")]
    pub computer_filter: Option<Box<crate::models::ComputerFilter>>,
}

impl ScanForOpenPortsTaskParameters {
    /// Controls the behavior of a scheduled task of type scan-for-open-ports.
    pub fn new() -> ScanForOpenPortsTaskParameters {
