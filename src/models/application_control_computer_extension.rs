...
pub struct ApplicationControlComputerExtension {
    ...
    #[serde(rename = "maintenanceModeStatus", skip_serializing_if = "Option::is_none")]
    pub maintenance_mode_status: Option<MaintenanceModeStatus>,
    /// Duration of maintenance mode in minutes.
    #[serde(rename = "maintenanceModeDuration", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "maintenanceModeStartTime", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "maintenanceModeEndTime", skip_serializing_if = "Option::is_none")]
