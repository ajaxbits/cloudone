...
pub struct DataCenterGatewayRights {
    ...
    #[serde(rename = "canCreateNewDataCenterGateways", skip_serializing_if = "Option::is_none")]
    pub can_create_new_data_center_gateways: Option<bool>,
    /// Right to view data center gateways.
    #[serde(rename = "canViewDataCenterGateways", skip_serializing_if = "Option::is_none")]
    pub can_view_data_center_gateways: Option<bool>,
    /// Right to edit data center gateways.
    #[serde(rename = "canEditDataCenterGateways", skip_serializing_if = "Option::is_none")]
    pub can_edit_data_center_gateways: Option<bool>,
    /// Right to delete data center gateways.
    #[serde(rename = "canDeleteDataCenterGateways", skip_serializing_if = "Option::is_none")]
