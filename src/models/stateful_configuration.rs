...
pub struct StatefulConfiguration {
    ...
    #[serde(rename = "denyFragmentedPacketsEnabled", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "denyPacketsContainingCwrOrEceEnabled", skip_serializing_if = "Option::is_none")]
    pub deny_packets_containing_cwr_or_ece_enabled: Option<bool>,
    /// Maximum allowed incoming connections. Searchable as Numeric.
    #[serde(rename = "maxIncomingConnections", skip_serializing_if = "Option::is_none")]
    pub max_incoming_connections: Option<i32>,
    /// Maximum allowed outgoing connections. Searchable as Numeric.
    #[serde(rename = "maxOutgoingConnections", skip_serializing_if = "Option::is_none")]
    pub max_outgoing_connections: Option<i32>,
    /// Maximum allowed half open connections. Searchable as Numeric.
    #[serde(rename = "maxHalfOpenConnections", skip_serializing_if = "Option::is_none")]
    pub max_half_open_connections: Option<i32>,
    #[serde(rename = "tcpstatefulInspectionEnabled", skip_serializing_if = "Option::is_none")]
    pub tcpstateful_inspection_enabled: Option<bool>,
    #[serde(rename = "tcpstatefulLoggingEnabled", skip_serializing_if = "Option::is_none")]
    pub tcpstateful_logging_enabled: Option<bool>,
    #[serde(rename = "udpstatefulInspectionEnabled", skip_serializing_if = "Option::is_none")]
    pub udpstateful_inspection_enabled: Option<bool>,
    #[serde(rename = "udpstatefulLoggingEnabled", skip_serializing_if = "Option::is_none")]
    pub udpstateful_logging_enabled: Option<bool>,
    #[serde(rename = "icmpstatefulInspectionEnabled", skip_serializing_if = "Option::is_none")]
    pub icmpstateful_inspection_enabled: Option<bool>,
    #[serde(rename = "icmpstatefulLoggingEnabled", skip_serializing_if = "Option::is_none")]
