...
/// AzureArmVirtualMachineSummary : Details of an Azure virtual machine that is managed using the Azure Resource Manager (ARM).

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AzureArmVirtualMachineSummary {
    ...
    #[serde(rename = "deploymentModel", skip_serializing_if = "Option::is_none")]
