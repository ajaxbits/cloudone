...
/// WebReputationComputerExtension : Computer-level configuration for the Web Reputation module. Null for tenants for whom Web Reputation is hidden.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebReputationComputerExtension {
