...
pub struct ComputerRights {
    ...
    #[serde(rename = "canAddAndRemoveComputerGroups", skip_serializing_if = "Option::is_none")]
    pub can_add_and_remove_computer_groups: Option<bool>,
    /// Right to create new computers.
    #[serde(rename = "canCreateNewComputers", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "canEditComputerProperties", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "canManageCloudAccounts", skip_serializing_if = "Option::is_none")]
    pub can_manage_cloud_accounts: Option<bool>,
    /// Right to manage directories.
    #[serde(rename = "canManageDirectories", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "canViewNotRelatedToComputers", skip_serializing_if = "Option::is_none")]
    pub can_view_not_related_to_computers: Option<bool>,
    /// Right to view non-selected computers.
    #[serde(rename = "canViewOtherComputers", skip_serializing_if = "Option::is_none")]
