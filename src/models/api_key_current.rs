...
/// ApiKeyCurrent : Details of an API key. Use API keys to authenticate requests with Deep Security Manager.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiKeyCurrent {
    ...
    #[serde(rename = "roleURN", skip_serializing_if = "Option::is_none")]
    pub role_urn: Option<String>,
