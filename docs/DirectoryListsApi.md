...
------------- | ------------- | -------------
[**create_directory_list**](DirectoryListsApi.md#create_directory_list) | **POST** /directorylists | Create a Directory List
[**delete_directory_list**](DirectoryListsApi.md#delete_directory_list) | **DELETE** /directorylists/{directoryListID} | Delete a Directory List
[**describe_directory_list**](DirectoryListsApi.md#describe_directory_list) | **GET** /directorylists/{directoryListID} | Describe a Directory List
[**list_directory_lists**](DirectoryListsApi.md#list_directory_lists) | **GET** /directorylists | List Directory Lists
[**modify_directory_list**](DirectoryListsApi.md#modify_directory_list) | **POST** /directorylists/{directoryListID} | Modify a Directory List
[**search_directory_lists**](DirectoryListsApi.md#search_directory_lists) | **POST** /directorylists/search | Search Directory Lists



## create_directory_list

> crate::models::DirectoryList create_directory_list(api_version, directory_list)
...
**directory_list** | [**DirectoryList**](DirectoryList.md) | The settings of the new directory list. | [required] |

### Return type

[**crate::models::DirectoryList**](directoryList.md)
...
> delete_directory_list(directory_list_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**directory_list_id** | **i32** | The ID number of the directory list to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## describe_directory_list

> crate::models::DirectoryList describe_directory_list(directory_list_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**directory_list_id** | **i32** | The ID number of the directory list to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## list_directory_lists

> crate::models::DirectoryLists list_directory_lists(api_version)
...
[**crate::models::DirectoryLists**](DirectoryLists.md)
...
> crate::models::DirectoryList modify_directory_list(directory_list_id, api_version, directory_list)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**directory_list_id** | **i32** | The ID number of the directory list to modify. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**directory_list** | [**DirectoryList**](DirectoryList.md) | The settings of the directory list to modify. | [required] |
...
## search_directory_lists

> crate::models::DirectoryLists search_directory_lists(api_version, search_filter)
