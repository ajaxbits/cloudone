...
------------- | ------------- | -------------
[**create_computer_group**](ComputerGroupsApi.md#create_computer_group) | **POST** /computergroups | Create a Computer Group
[**delete_computer_group**](ComputerGroupsApi.md#delete_computer_group) | **DELETE** /computergroups/{computerGroupID} | Delete a Computer Group
[**describe_computer_group**](ComputerGroupsApi.md#describe_computer_group) | **GET** /computergroups/{computerGroupID} | Describe a Computer Group
[**list_computer_groups**](ComputerGroupsApi.md#list_computer_groups) | **GET** /computergroups | List Computer Groups
[**modify_computer_group**](ComputerGroupsApi.md#modify_computer_group) | **POST** /computergroups/{computerGroupID} | Modify a Computer Group
[**search_computer_groups**](ComputerGroupsApi.md#search_computer_groups) | **POST** /computergroups/search | Search Computer Groups



## create_computer_group

> crate::models::ComputerGroup create_computer_group(api_version, computer_group)
...
**computer_group** | [**ComputerGroup**](ComputerGroup.md) | The settings of the new computer group. | [required] |

### Return type

[**crate::models::ComputerGroup**](computerGroup.md)
...
> delete_computer_group(computer_group_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**computer_group_id** | **i32** | The ID number of the computer group to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## describe_computer_group

> crate::models::ComputerGroup describe_computer_group(computer_group_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**computer_group_id** | **i32** | The ID number of the computer group to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::ComputerGroups list_computer_groups(api_version)
...
[**crate::models::ComputerGroups**](ComputerGroups.md)
...
## modify_computer_group

> crate::models::ComputerGroup modify_computer_group(computer_group_id, api_version, computer_group)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**computer_group_id** | **i32** | The ID number of the computer group to modify. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**computer_group** | Option<[**ComputerGroup**](ComputerGroup.md)> | The settings of the computer group to modify. |  |
...
## search_computer_groups

> crate::models::ComputerGroups search_computer_groups(api_version, search_filter)
