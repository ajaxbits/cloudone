# \AWSConnectorSettingsApi

All URIs are relative to *https://workload.us-1.cloudone.trendmicro.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_aws_connector_settings**](AWSConnectorSettingsApi.md#list_aws_connector_settings) | **GET** /awsconnectorsettings | List AWS Connector Settings



## list_aws_connector_settings

> crate::models::Awsconnectorsettings list_aws_connector_settings(api_version)
...
[**crate::models::Awsconnectorsettings**](awsconnectorsettings.md)
