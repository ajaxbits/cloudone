...
------------- | ------------- | -------------
[**create_aws_connector**](AWSConnectorsApi.md#create_aws_connector) | **POST** /awsconnectors | Create an AWS Connector
[**delete_aws_connector**](AWSConnectorsApi.md#delete_aws_connector) | **DELETE** /awsconnectors/{awsConnectorID} | Delete an AWS Connector
[**describe_aws_connector**](AWSConnectorsApi.md#describe_aws_connector) | **GET** /awsconnectors/{awsConnectorID} | Describe an existing AWS Connector
[**list_aws_connectors**](AWSConnectorsApi.md#list_aws_connectors) | **GET** /awsconnectors | List AWS Connectors
[**modify_aws_connector**](AWSConnectorsApi.md#modify_aws_connector) | **POST** /awsconnectors/{awsConnectorID} | Modify an AWS Connector
[**search_aws_connectors**](AWSConnectorsApi.md#search_aws_connectors) | **POST** /awsconnectors/search | Search AWS Connectors



## create_aws_connector

> crate::models::AwsConnector create_aws_connector(api_version, aws_connector)
...
**aws_connector** | [**AwsConnector**](AwsConnector.md) | The settings of the new AWS Connector. | [required] |

### Return type

[**crate::models::AwsConnector**](AWSConnector.md)
...
> delete_aws_connector(aws_connector_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**aws_connector_id** | **i32** | The ID number of the AWS Connector to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## describe_aws_connector

> crate::models::AwsConnector describe_aws_connector(aws_connector_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**aws_connector_id** | **i32** | The ID number of the AWS Connector to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::AwsConnectors list_aws_connectors(api_version)
List AWS Connectors
...
[**crate::models::AwsConnectors**](AWSConnectors.md)
...
## modify_aws_connector

> crate::models::AwsConnector modify_aws_connector(aws_connector_id, api_version, aws_connector, sync)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**aws_connector_id** | **i32** | The ID number of the AWS Connector to modify. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**aws_connector** | [**AwsConnector**](AwsConnector.md) | The settings of the AWS Connector to modify. | [required] |
**sync** | Option<**bool**> | Immediately trigger a synchronization for the AWS Connector. |  |
...
## search_aws_connectors

> crate::models::AwsConnectors search_aws_connectors(api_version, search_filter)
