...
------------- | ------------- | -------------
[**describe_system_setting**](SystemSettingsApi.md#describe_system_setting) | **GET** /systemsettings/{name} | Describe a System Setting
[**list_system_settings**](SystemSettingsApi.md#list_system_settings) | **GET** /systemsettings | List System Settings
[**modify_system_setting**](SystemSettingsApi.md#modify_system_setting) | **POST** /systemsettings/{name} | Modify a System Setting
[**modify_system_settings**](SystemSettingsApi.md#modify_system_settings) | **POST** /systemsettings | Modify System Settings
[**reset_system_setting**](SystemSettingsApi.md#reset_system_setting) | **DELETE** /systemsettings/{name} | Reset a System Setting



## describe_system_setting

> crate::models::SettingValue describe_system_setting(name, api_version)
...
------------- | ------------- | ------------- | ------------- | -------------
**name** | **String** | The name of the system setting. | [required] |
...
> crate::models::SystemSettings list_system_settings(api_version)
...
[**crate::models::SystemSettings**](SystemSettings.md)
...
> crate::models::SettingValue modify_system_setting(name, api_version, setting_value)
...
**api_version** | **String** | The version of the api being called. | [required] |
**setting_value** | [**SettingValue**](SettingValue.md) | The new value for the setting setting. | [required] |
...
> crate::models::SystemSettings modify_system_settings(api_version, system_settings)
...
------------- | ------------- | ------------- | ------------- | -------------
**api_version** | **String** | The version of the api being called. | [required] |
**system_settings** | [**SystemSettings**](SystemSettings.md) | The system settings to modify. | [required] |
...
> crate::models::SettingValue reset_system_setting(name, api_version)
