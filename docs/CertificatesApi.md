...
------------- | ------------- | -------------
[**add_certificate**](CertificatesApi.md#add_certificate) | **POST** /certificates | Add a Certificate
[**delete_certificate**](CertificatesApi.md#delete_certificate) | **DELETE** /certificates/{certificateID} | Delete a Certificate
[**describe_certificate**](CertificatesApi.md#describe_certificate) | **GET** /certificates/{certificateID} | Describe a Certificate
[**list_certificates**](CertificatesApi.md#list_certificates) | **GET** /certificates | List Certificates
[**target_certificate**](CertificatesApi.md#target_certificate) | **GET** /certificates/target | Retrieve a Certificate by URL



## add_certificate

> crate::models::Certificate add_certificate(api_version, certificate)
Add a Certificate
...
**certificate** | [**Certificate**](Certificate.md) |  | [required] |
...
> delete_certificate(certificate_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**certificate_id** | **i32** | The ID number of the certificate to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::Certificate describe_certificate(certificate_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**certificate_id** | **i32** | The ID number of the certificate to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::Certificates list_certificates(api_version)
List Certificates
...
[**crate::models::Certificates**](certificates.md)
...
> crate::models::Certificate target_certificate(URL, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**URL** | **String** | The URL of the certificate to describe | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
