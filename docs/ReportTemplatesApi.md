...
------------- | ------------- | -------------
[**describe_report_template**](ReportTemplatesApi.md#describe_report_template) | **GET** /reporttemplates/{reportTemplateID} | Describe a Report
[**list_report_templates**](ReportTemplatesApi.md#list_report_templates) | **GET** /reporttemplates | List Reports
[**search_report_templates**](ReportTemplatesApi.md#search_report_templates) | **POST** /reporttemplates/search | Search Reports



## describe_report_template

> crate::models::ReportTemplate describe_report_template(report_template_id, api_version)
Describe a Report
...
------------- | ------------- | ------------- | ------------- | -------------
**report_template_id** | **i32** | The ID number of the report to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |

### Return type

[**crate::models::ReportTemplate**](ReportTemplate.md)
...
> crate::models::ReportTemplates list_report_templates(api_version)
List Reports
...
[**crate::models::ReportTemplates**](ReportTemplates.md)
...
> crate::models::ReportTemplates search_report_templates(api_version, search_filter)
Search Reports
