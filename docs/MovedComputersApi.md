...
**moved_computer** | [**MovedComputer**](MovedComputer.md) | The content of a new moved computer to create. | [required] |

### Return type

[**crate::models::MovedComputer**](movedComputer.md)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**moved_computer_id** | **i32** | The ID number of the moved computer to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
[**crate::models::MovedComputers**](MovedComputers.md)
