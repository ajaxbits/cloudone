# \VCenterConnectorActionsApi

All URIs are relative to *https://workload.us-1.cloudone.trendmicro.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_v_center_connector_action**](VCenterConnectorActionsApi.md#create_v_center_connector_action) | **POST** /vcenterconnectors/{virtualID}/actions | Create a connector action
[**describe_v_center_connector_action**](VCenterConnectorActionsApi.md#describe_v_center_connector_action) | **GET** /vcenterconnectors/{virtualID}/actions/{actionID} | Describe a connector action



## create_v_center_connector_action

> crate::models::VCenterConnectorAction create_v_center_connector_action(virtual_id, api_version, v_center_connector_action)
...
------------- | ------------- | ------------- | ------------- | -------------
**virtual_id** | **i32** | ID number of the vCenter connector. | [required] |
**api_version** | **String** | Version of the API being called. | [required] |
**v_center_connector_action** | [**VCenterConnectorAction**](VCenterConnectorAction.md) | Property of the new vCenter connector action. | [required] |

### Return type

[**crate::models::VCenterConnectorAction**](vCenterConnectorAction.md)
...
## describe_v_center_connector_action

> crate::models::VCenterConnectorAction describe_v_center_connector_action(virtual_id, action_id, api_version)
...
------------- | ------------- | ------------- | ------------- | -------------
**virtual_id** | **i32** | ID number of the vCenter connector. | [required] |
**action_id** | **i64** | ID number of the vCenter connector action. | [required] |
**api_version** | **String** | Version of the API being called. | [required] |
