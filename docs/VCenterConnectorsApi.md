# \VCenterConnectorsApi

All URIs are relative to *https://workload.us-1.cloudone.trendmicro.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_v_center_connector**](VCenterConnectorsApi.md#create_v_center_connector) | **POST** /vcenterconnectors | Create a vCenter connector
[**delete_v_center_connector**](VCenterConnectorsApi.md#delete_v_center_connector) | **DELETE** /vcenterconnectors/{virtualID} | Delete a vCenter connector
[**describe_v_center_connector**](VCenterConnectorsApi.md#describe_v_center_connector) | **GET** /vcenterconnectors/{virtualID} | Describe a vCenter Connector
[**list_v_center_connectors**](VCenterConnectorsApi.md#list_v_center_connectors) | **GET** /vcenterconnectors | List vCenter connectors
[**modify_v_center_connector**](VCenterConnectorsApi.md#modify_v_center_connector) | **POST** /vcenterconnectors/{virtualID} | Modify a vCenter Connector



## create_v_center_connector

> crate::models::VCenterConnector create_v_center_connector(api_version, v_center_connector)
...
------------- | ------------- | ------------- | ------------- | -------------
**api_version** | **String** | Version of the API being called. | [required] |
**v_center_connector** | [**VCenterConnector**](VCenterConnector.md) | Settings for the new vCenter connector. | [required] |

### Return type

[**crate::models::VCenterConnector**](VCenterConnector.md)
...
## delete_v_center_connector

> delete_v_center_connector(virtual_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**virtual_id** | **i32** | ID number of the vCenter Connector to be deleted. | [required] |
**api_version** | **String** | Version of the API being called. | [required] |
...
## describe_v_center_connector

> crate::models::VCenterConnector describe_v_center_connector(virtual_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**virtual_id** | **i32** | ID number of the vCenter connector to describe. | [required] |
**api_version** | **String** | Version of the API being called. | [required] |
...
## list_v_center_connectors

> crate::models::VCenterConnectors list_v_center_connectors(api_version)
...
[**crate::models::VCenterConnectors**](VCenterConnectors.md)
...
## modify_v_center_connector

> crate::models::VCenterConnector modify_v_center_connector(virtual_id, api_version, v_center_connector)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**virtual_id** | **i32** | ID number of the vCenter Connector to modify. | [required] |
**api_version** | **String** | Version of the API being called. | [required] |
**v_center_connector** | Option<[**VCenterConnector**](VCenterConnector.md)> | The settings of the vCenter connector to modify. |  |
