...
------------- | ------------- | -------------
[**describe_current_account_details**](AccountDetailsApi.md#describe_current_account_details) | **GET** /accountdetails/current | Describe current Account Details



## describe_current_account_details

> crate::models::AccountDetails describe_current_account_details(api_version)
