# \SoftwareInventoriesApi

All URIs are relative to *https://workload.us-1.cloudone.trendmicro.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_software_inventory**](SoftwareInventoriesApi.md#create_software_inventory) | **POST** /softwareinventories | Create a Software Inventory
[**delete_software_inventory**](SoftwareInventoriesApi.md#delete_software_inventory) | **DELETE** /softwareinventories/{softwareInventoryID} | Delete a Software Inventory
[**describe_software_inventory**](SoftwareInventoriesApi.md#describe_software_inventory) | **GET** /softwareinventories/{softwareInventoryID} | Describe a Software Inventory
[**describe_software_inventory_item**](SoftwareInventoriesApi.md#describe_software_inventory_item) | **GET** /softwareinventories/{softwareInventoryID}/items/{inventoryItemID} | Describe a Software Inventory Item
[**list_software_inventories**](SoftwareInventoriesApi.md#list_software_inventories) | **GET** /softwareinventories | List Software Inventories
[**list_software_inventory_items**](SoftwareInventoriesApi.md#list_software_inventory_items) | **GET** /softwareinventories/{softwareInventoryID}/items | List Software Inventory Items
[**search_software_inventories**](SoftwareInventoriesApi.md#search_software_inventories) | **POST** /softwareinventories/search | Search Software Inventories
[**search_software_inventory_items**](SoftwareInventoriesApi.md#search_software_inventory_items) | **POST** /softwareinventories/{softwareInventoryID}/items/search | Search Software Inventory Items



## create_software_inventory

> crate::models::SoftwareInventory create_software_inventory(api_version, software_inventory)
...
**software_inventory** | [**SoftwareInventory**](SoftwareInventory.md) | The settings of the new software inventory. | [required] |

### Return type

[**crate::models::SoftwareInventory**](softwareInventory.md)
...
## delete_software_inventory

> delete_software_inventory(software_inventory_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**software_inventory_id** | **i64** | The ID number of the software inventory to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## describe_software_inventory

> crate::models::SoftwareInventory describe_software_inventory(software_inventory_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**software_inventory_id** | **i64** | The ID number of the software inventory to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## describe_software_inventory_item

> crate::models::InventoryItem describe_software_inventory_item(software_inventory_id, inventory_item_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**software_inventory_id** | **i64** | The ID number of the software inventory. | [required] |
**inventory_item_id** | **i64** | The ID number of the inventory item to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## list_software_inventories

> crate::models::SoftwareInventories list_software_inventories(api_version)
...
[**crate::models::SoftwareInventories**](softwareInventories.md)
...
## list_software_inventory_items

> crate::models::InventoryItems list_software_inventory_items(software_inventory_id, api_version)
...
[**crate::models::InventoryItems**](inventoryItems.md)
...
## search_software_inventories

> crate::models::SoftwareInventories search_software_inventories(api_version, search_filter)
...
## search_software_inventory_items

> crate::models::InventoryItems search_software_inventory_items(software_inventory_id, api_version, search_filter)
