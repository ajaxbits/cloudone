# \PolicyImportTasksApi

All URIs are relative to *https://workload.us-1.cloudone.trendmicro.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_policy_import_task**](PolicyImportTasksApi.md#create_policy_import_task) | **POST** /policyimporttasks | Create a PolicyImportTask
[**describe_policy_import_task**](PolicyImportTasksApi.md#describe_policy_import_task) | **GET** /policyimporttasks/{policyImportTaskID} | Describe a PolicyImportTask
[**list_policy_import_tasks**](PolicyImportTasksApi.md#list_policy_import_tasks) | **GET** /policyimporttasks | List PolicyImportTasks
[**search_policy_import_tasks**](PolicyImportTasksApi.md#search_policy_import_tasks) | **POST** /policyimporttasks/search | Search PolicyImportTasks



## create_policy_import_task

> crate::models::PolicyImportTask create_policy_import_task(api_version, policy_import_task)
...
**policy_import_task** | Option<[**PolicyImportTask**](PolicyImportTask.md)> | Policy import task to create |  |

### Return type

[**crate::models::PolicyImportTask**](policyImportTask.md)
...
## describe_policy_import_task

> crate::models::PolicyImportTask describe_policy_import_task(policy_import_task_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**policy_import_task_id** | **i32** | The ID number of the policy import task to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## list_policy_import_tasks

> crate::models::PolicyImportTasks list_policy_import_tasks(api_version)
...
[**crate::models::PolicyImportTasks**](PolicyImportTasks.md)
...
## search_policy_import_tasks

> crate::models::PolicyImportTasks search_policy_import_tasks(api_version, search_filter)
