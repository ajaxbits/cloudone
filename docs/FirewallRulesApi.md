...
------------- | ------------- | -------------
[**create_firewall_rule**](FirewallRulesApi.md#create_firewall_rule) | **POST** /firewallrules | Create a Firewall Rule
[**delete_firewall_rule**](FirewallRulesApi.md#delete_firewall_rule) | **DELETE** /firewallrules/{firewallRuleID} | Delete a Firewall Rule
[**describe_firewall_rule**](FirewallRulesApi.md#describe_firewall_rule) | **GET** /firewallrules/{firewallRuleID} | Describe a Firewall Rule
[**list_firewall_rules**](FirewallRulesApi.md#list_firewall_rules) | **GET** /firewallrules | List Firewall Rules
[**modify_firewall_rule**](FirewallRulesApi.md#modify_firewall_rule) | **POST** /firewallrules/{firewallRuleID} | Modify a Firewall Rule
[**search_firewall_rules**](FirewallRulesApi.md#search_firewall_rules) | **POST** /firewallrules/search | Search Firewall Rules



## create_firewall_rule

> crate::models::FirewallRule create_firewall_rule(api_version, firewall_rule)
...
**firewall_rule** | [**FirewallRule**](FirewallRule.md) | The settings of the new firewall rule. | [required] |
...
> delete_firewall_rule(firewall_rule_id, api_version)
...
> crate::models::FirewallRule describe_firewall_rule(firewall_rule_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**firewall_rule_id** | **i32** | The ID number of the firewall rule to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::FirewallRules list_firewall_rules(api_version)
List Firewall Rules
...
> crate::models::FirewallRule modify_firewall_rule(firewall_rule_id, api_version, firewall_rule)
...
> crate::models::FirewallRules search_firewall_rules(api_version, search_filter)
