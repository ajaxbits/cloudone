...
------------- | ------------- | -------------
[**create_administrator_role**](AdministratorRolesApi.md#create_administrator_role) | **POST** /roles | Create an Administrator Role
[**delete_administrator_role**](AdministratorRolesApi.md#delete_administrator_role) | **DELETE** /roles/{roleID} | Delete an Administrator Role
[**describe_administrator_role**](AdministratorRolesApi.md#describe_administrator_role) | **GET** /roles/{roleID} | Describe an Administrator Role
[**list_administrator_roles**](AdministratorRolesApi.md#list_administrator_roles) | **GET** /roles | List Administrator Roles
[**modify_administrator_role**](AdministratorRolesApi.md#modify_administrator_role) | **POST** /roles/{roleID} | Modify an Administrator Role
[**search_administrator_roles**](AdministratorRolesApi.md#search_administrator_roles) | **POST** /roles/search | Search Administrator Roles



## create_administrator_role

> crate::models::Role create_administrator_role(api_version, role)
...
**role** | [**Role**](Role.md) | The settings of the new administrator role. | [required] |
...
## delete_administrator_role

> delete_administrator_role(role_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**role_id** | **i32** | The ID number of the administrator role to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## describe_administrator_role

> crate::models::Role describe_administrator_role(role_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**role_id** | **i32** | The ID number of the administrator role to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::AdministratorRoles list_administrator_roles(api_version)
...
[**crate::models::AdministratorRoles**](AdministratorRoles.md)
...
## modify_administrator_role

> crate::models::Role modify_administrator_role(role_id, api_version, role)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**role_id** | **i32** | The ID number of the administrator role to modify. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**role** | [**Role**](Role.md) | The settings of the administrator role to modify. | [required] |
...
## search_administrator_roles

> crate::models::AdministratorRoles search_administrator_roles(api_version, search_filter)
