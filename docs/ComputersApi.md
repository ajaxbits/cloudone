...
------------- | ------------- | -------------
[**create_computer**](ComputersApi.md#create_computer) | **POST** /computers | Create a Computer
[**delete_computer**](ComputersApi.md#delete_computer) | **DELETE** /computers/{computerID} | Delete a Computer
[**delete_computers**](ComputersApi.md#delete_computers) | **DELETE** /computers | Delete Computers
[**describe_computer**](ComputersApi.md#describe_computer) | **GET** /computers/{computerID} | Describe a Computer
[**describe_computer_setting**](ComputersApi.md#describe_computer_setting) | **GET** /computers/{computerID}/settings/{name} | Describe a Computer Setting
[**list_computers**](ComputersApi.md#list_computers) | **GET** /computers | List Computers
[**modify_computer**](ComputersApi.md#modify_computer) | **POST** /computers/{computerID} | Modify a Computer
[**modify_computer_setting**](ComputersApi.md#modify_computer_setting) | **POST** /computers/{computerID}/settings/{name} | Modify a Computer Setting
[**reset_computer_setting**](ComputersApi.md#reset_computer_setting) | **DELETE** /computers/{computerID}/settings/{name} | Reset a Computer Setting
[**search_computers**](ComputersApi.md#search_computers) | **POST** /computers/search | Search Computers



## create_computer

> crate::models::Computer create_computer(api_version, computer, expand, overrides)
Create a Computer
...
**computer** | [**Computer**](Computer.md) | The settings of the new computer. | [required] |
**expand** | Option<[**Vec<String>**](String.md)> | Determines the computer information to include in the response. Use \"none\" to retrieve only basic computer information such as policyID and hostName. Use one or several expand options to retrieve a tailored response in addition to the basic information. Use \"all\" to retrieve all of the computer information. The default is \"all\", but we recommend using \"none\" or a limited set of options on all requests to improve performance. |  |
**overrides** | Option<**bool**> | Show only overrides defined for the current computer. |  |

### Return type

[**crate::models::Computer**](computer.md)
...
> delete_computer(computer_id, api_version)
Delete a Computer
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**computer_id** | **i32** | The ID number of the computer to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> delete_computers(api_version, computers_to_be_deleted_id_list)
Delete Computers
...
------------- | ------------- | ------------- | ------------- | -------------
**api_version** | **String** | The version of the api being called. | [required] |
**computers_to_be_deleted_id_list** | [**ComputersToBeDeletedIdList**](ComputersToBeDeletedIdList.md) | The ID list of the computers to be deleted. | [required] |
...
> crate::models::Computer describe_computer(computer_id, api_version, expand, overrides)
Describe a Computer
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**computer_id** | **i32** | The ID number of the computer to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**expand** | Option<[**Vec<String>**](String.md)> | Determines the computer information to include in the response. Use \"none\" to retrieve only basic computer information such as policyID and hostName. Use one or several expand options to retrieve a tailored response in addition to the basic information. Use \"all\" to retrieve all of the computer information. The default is \"all\", but we recommend using \"none\" or a limited set of options on all requests to improve performance. |  |
**overrides** | Option<**bool**> | Show only overrides defined for the current computer. |  |
...
## describe_computer_setting

> crate::models::SettingValue describe_computer_setting(computer_id, name, api_version, overrides)
...
**api_version** | **String** | The version of the api being called. | [required] |
**overrides** | Option<**bool**> | Show the value only if defined for the current computer. |  |
...
> crate::models::Computers list_computers(api_version, expand, overrides)
List Computers
...
[**crate::models::Computers**](Computers.md)
...
> crate::models::Computer modify_computer(computer_id, api_version, computer, expand, overrides)
Modify a Computer
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**computer_id** | **i32** | The ID number of the computer to modify. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**computer** | [**Computer**](Computer.md) | The settings of the computer to modify. | [required] |
**expand** | Option<[**Vec<String>**](String.md)> | Determines the computer information to include in the response. Use \"none\" to retrieve only basic computer information such as policyID and hostName. Use one or several expand options to retrieve a tailored response in addition to the basic information. Use \"all\" to retrieve all of the computer information. The default is \"all\", but we recommend using \"none\" or a limited set of options on all requests to improve performance. |  |
**overrides** | Option<**bool**> | Show only overrides defined for the current computer. |  |
...
## modify_computer_setting

> crate::models::SettingValue modify_computer_setting(computer_id, name, api_version, setting_value, overrides)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**computer_id** | **i32** | The ID number of the policy. | [required] |
**name** | **String** | The name of the setting. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**setting_value** | [**SettingValue**](SettingValue.md) | The new value for the setting. | [required] |
**overrides** | Option<**bool**> | Show the value only if defined for the current computer. |  |
...
> crate::models::SettingValue reset_computer_setting(computer_id, name, api_version, overrides)
...
> crate::models::Computers search_computers(api_version, expand, overrides, search_filter)
Search Computers
