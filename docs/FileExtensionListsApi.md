# \FileExtensionListsApi

All URIs are relative to *https://workload.us-1.cloudone.trendmicro.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_file_extension_list**](FileExtensionListsApi.md#create_file_extension_list) | **POST** /fileextensionlists | Create a File Extension List
[**delete_file_extension_list**](FileExtensionListsApi.md#delete_file_extension_list) | **DELETE** /fileextensionlists/{fileExtensionListID} | Delete a File Extension List
[**describe_file_extension_list**](FileExtensionListsApi.md#describe_file_extension_list) | **GET** /fileextensionlists/{fileExtensionListID} | Describe a File Extension List
[**list_file_extension_lists**](FileExtensionListsApi.md#list_file_extension_lists) | **GET** /fileextensionlists | List File Extension Lists
[**modify_file_extension_list**](FileExtensionListsApi.md#modify_file_extension_list) | **POST** /fileextensionlists/{fileExtensionListID} | Modify a File Extension List
[**search_file_extension_lists**](FileExtensionListsApi.md#search_file_extension_lists) | **POST** /fileextensionlists/search | Search File Extension Lists



## create_file_extension_list

> crate::models::FileExtensionList create_file_extension_list(api_version, file_extension_list)
...
**file_extension_list** | [**FileExtensionList**](FileExtensionList.md) | The settings of the new file extension list. | [required] |

### Return type

[**crate::models::FileExtensionList**](fileExtensionList.md)
...
> delete_file_extension_list(file_extension_list_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**file_extension_list_id** | **i32** | The ID number of the file extension list to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## describe_file_extension_list

> crate::models::FileExtensionList describe_file_extension_list(file_extension_list_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**file_extension_list_id** | **i32** | The ID number of the file extension list to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
## list_file_extension_lists

> crate::models::FileExtensionLists list_file_extension_lists(api_version)
...
[**crate::models::FileExtensionLists**](FileExtensionLists.md)
...
> crate::models::FileExtensionList modify_file_extension_list(file_extension_list_id, api_version, file_extension_list)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**file_extension_list_id** | **i32** | The ID number of the file extension list to modify. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**file_extension_list** | [**FileExtensionList**](FileExtensionList.md) | The settings of the file extension list to modify. | [required] |
...
## search_file_extension_lists

> crate::models::FileExtensionLists search_file_extension_lists(api_version, search_filter)
