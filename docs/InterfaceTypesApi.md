...
------------- | ------------- | -------------
[**create_interface_type**](InterfaceTypesApi.md#create_interface_type) | **POST** /policies/{policyID}/interfacetypes | Create an Interface Type
[**delete_interface_type**](InterfaceTypesApi.md#delete_interface_type) | **DELETE** /policies/{policyID}/interfacetypes/{interfaceTypeID} | Delete an Interface Type
[**describe_interface_type**](InterfaceTypesApi.md#describe_interface_type) | **GET** /policies/{policyID}/interfacetypes/{interfaceTypeID} | Describe an Interface Type
[**list_interface_types**](InterfaceTypesApi.md#list_interface_types) | **GET** /policies/{policyID}/interfacetypes | List Interface Types
[**modify_interface_type**](InterfaceTypesApi.md#modify_interface_type) | **POST** /policies/{policyID}/interfacetypes/{interfaceTypeID} | Modify an Interface Type
[**search_interface_types**](InterfaceTypesApi.md#search_interface_types) | **POST** /policies/{policyID}/interfacetypes/search | Search Interface Types



## create_interface_type

> crate::models::InterfaceType create_interface_type(policy_id, api_version, interface_type)
...
**interface_type** | Option<[**InterfaceType**](InterfaceType.md)> | The settings of the new interface type. |  |

### Return type

[**crate::models::InterfaceType**](interfaceType.md)
...
> delete_interface_type(policy_id, interface_type_id, api_version)
...
------------- | ------------- | ------------- | ------------- | -------------
**policy_id** | **i32** | The ID number of the policy. | [required] |
**interface_type_id** | **i32** | The ID number of the interface type to delete. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::InterfaceType describe_interface_type(policy_id, interface_type_id, api_version)
...
------------- | ------------- | ------------- | ------------- | -------------
**policy_id** | **i32** | The ID number of the policy. | [required] |
**interface_type_id** | **i32** | The ID number of the interface type to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::InterfaceTypes list_interface_types(policy_id, api_version)
...
[**crate::models::InterfaceTypes**](InterfaceTypes.md)
...
## modify_interface_type

> crate::models::InterfaceType modify_interface_type(policy_id, interface_type_id, api_version, interface_type)
...
------------- | ------------- | ------------- | ------------- | -------------
**policy_id** | **i32** | The ID number of the policy. | [required] |
**interface_type_id** | **i32** | The ID number of the interface type to modify. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
**interface_type** | [**InterfaceType**](InterfaceType.md) | The settings of the interface type to modify. | [required] |
...
## search_interface_types

> crate::models::InterfaceTypes search_interface_types(policy_id, api_version, search_filter)
