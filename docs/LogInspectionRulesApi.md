...
------------- | ------------- | -------------
[**create_log_inspection_rule**](LogInspectionRulesApi.md#create_log_inspection_rule) | **POST** /loginspectionrules | Create a Log Inspection Rule
[**delete_log_inspection_rule**](LogInspectionRulesApi.md#delete_log_inspection_rule) | **DELETE** /loginspectionrules/{logInspectionRuleID} | Delete a Log Inspection Rule
[**describe_log_inspection_rule**](LogInspectionRulesApi.md#describe_log_inspection_rule) | **GET** /loginspectionrules/{logInspectionRuleID} | Describe a Log Inspection Rule
[**list_log_inspection_rules**](LogInspectionRulesApi.md#list_log_inspection_rules) | **GET** /loginspectionrules | List Log Inspection Rules
[**modify_log_inspection_rule**](LogInspectionRulesApi.md#modify_log_inspection_rule) | **POST** /loginspectionrules/{logInspectionRuleID} | Modify a Log Inspection Rule
[**search_log_inspection_rules**](LogInspectionRulesApi.md#search_log_inspection_rules) | **POST** /loginspectionrules/search | Search Log Inspection Rules



## create_log_inspection_rule

> crate::models::LogInspectionRule create_log_inspection_rule(api_version, log_inspection_rule)
...
**log_inspection_rule** | [**LogInspectionRule**](LogInspectionRule.md) | The settings of the new log inspection rule. | [required] |
...
## delete_log_inspection_rule

> delete_log_inspection_rule(log_inspection_rule_id, api_version)
...
## describe_log_inspection_rule

> crate::models::LogInspectionRule describe_log_inspection_rule(log_inspection_rule_id, api_version)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**log_inspection_rule_id** | **i32** | The ID number of the log inspection rule to describe. | [required] |
**api_version** | **String** | The version of the api being called. | [required] |
...
> crate::models::LogInspectionRules list_log_inspection_rules(api_version)
...
## modify_log_inspection_rule

> crate::models::LogInspectionRule modify_log_inspection_rule(log_inspection_rule_id, api_version, log_inspection_rule)
...
## search_log_inspection_rules

> crate::models::LogInspectionRules search_log_inspection_rules(api_version, search_filter)
